...
public class MerchanMenu : MonoBehaviour
{
     public RecipeSimple[] merchandise;
        ...
        void Awake()
        {
            merchandise = Resources.LoadAll<RecipeSimple>("Merchandise");
            foreach (RecipeSimple recipe in merchandise)
            {
