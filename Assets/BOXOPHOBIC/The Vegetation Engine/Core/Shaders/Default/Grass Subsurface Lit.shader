	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 Mesh_PivotsData2831_g64460 = ( appendResult60_g64827 * _VertexPivotMode );
				half3 Mesh_PivotsOS2291_g64460 = Mesh_PivotsData2831_g64460;
				...
				float3 vertexToFrag4224_g64460 = temp_output_114_0_g64859;
				...
				half Motion_Selective4260_g64460 = 1.0;
				...
				float3 Vertex_Motion_Object833_g64460 = ( ( VertexPosRotationAxis50_g64782 + ( VertexPosOtherAxis82_g64782 * cos( Angle44_g64782 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g64782 ) * sin( Angle44_g64782 ) ) ) + Motion_30_Details263_g64460 );
				...
				float3 Vertex_Motion_World1118_g64460 = ( ( temp_output_3474_0_g64460 + appendResult2043_g64460 ) + Motion_30_Details263_g64460 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				float temp_output_335_0_g64460 = saturate( ( ( ( distance( _WorldSpaceCameraPos , ObjectPosition4223_g64460 ) * ( 1.0 / TVE_DistanceFadeBias ) ) - temp_output_7_0_g64812 ) / ( _SizeFadeStartValue - temp_output_7_0_g64812 ) ) );
				float3 appendResult3482_g64460 = (float3(temp_output_335_0_g64460 , temp_output_335_0_g64460 , temp_output_335_0_g64460));
				float3 lerpResult3556_g64460 = lerp( _Vector5 , appendResult3482_g64460 , _SizeFadeMode);
				half3 ObjectData20_g64815 = lerpResult3556_g64460;
				...
				#endif
				float3 Vertex_SizeFade1740_g64460 = staticSwitch14_g64815;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult2696_g64460 = normalize( ase_worldViewDir );
				float3 break2709_g64460 = cross( normalizeResult2696_g64460 , half3(0,1,0) );
				float3 appendResult2710_g64460 = (float3(-break2709_g64460.z , 0.0 , break2709_g64460.x));
				float3 appendResult2667_g64460 = (float3(inputMesh.ase_color.r , 0.5 , inputMesh.ase_color.r));
				...
				float dotResult2212_g64460 = dot( ViewDir_Normalized3963_g64460 , float3(0,1,0) );
				half Mask_HView2656_g64460 = dotResult2212_g64460;
				float saferPower2652_g64460 = abs( Mask_HView2656_g64460 );
				half3 Grass_Perspective2661_g64460 = ( ( ( mul( GetWorldToObjectMatrix(), float4( appendResult2710_g64460 , 0.0 ) ).xyz * _PerspectivePushValue ) + ( (appendResult2667_g64460*2.0 + -1.0) * _PerspectiveNoiseValue ) ) * inputMesh.ase_color.a * pow( saferPower2652_g64460 , _PerspectiveAngleValue ) );
				...
				half Noise_Tint2802_g64460 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_12 * WorldPosition3905_g64460 * 0.1 ), 0.0) ).r - temp_output_7_0_g64870 ) / ( _NoiseMaxValue - temp_output_7_0_g64870 ) ) );
				float vertexToFrag11_g64833 = Noise_Tint2802_g64460;
				outputPackedVaryingsMeshToPS.ase_texcoord5.y = vertexToFrag11_g64833;
				half Global_MotionHighlight4860_g64460 = ( (( sin( ( break500_g64882.x + break500_g64882.y ) ) * sin( ( break494_g64882.x + break494_g64882.y ) ) )*0.5 + 0.5) * (( sin( ( break500_g64882.x + break500_g64882.y ) ) * sin( ( break494_g64882.x + break494_g64882.y ) ) )*0.5 + 0.5) );
				half Highlight_Tint3231_g64460 = ( Global_MotionHighlight4860_g64460 * Global_MotionPower2223_g64460 * Wind_FadeOut4005_g64460 * Mesh_Height1524_g64460 );
				float vertexToFrag11_g64828 = Highlight_Tint3231_g64460;
						...
						)
			{
				...
				float3 lerpResult4521_g64460 = lerp( float3( 1,1,1 ) , ( lerpResult2779_g64460 * lerpResult2800_g64460 * ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g64828 ) + float3( 1,1,1 ) ) ) , Leaves_Mask4511_g64460);
				...
				half Global_Colors_Mask3692_g64460 = saturate( ( ( ( 1.0 - packedInput.ase_color.a ) - temp_output_7_0_g64858 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g64858 ) ) );
				...
				half Subsurface_Mask1557_g64460 = saturate( ( ( packedInput.ase_color.a - temp_output_7_0_g64872 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g64872 ) ) );
				...
				half Overlay_Mask269_g64460 = saturate( ( ( ( ( ( packedInput.ase_color.a * 0.5 ) + Main_AlbedoTex_G3526_g64460 ) * Overlay_Commons1365_g64460 ) - temp_output_7_0_g64869 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g64869 ) ) );
				...
				float3 lerpResult2945_g64460 = lerp( (_VertexOcclusionColor).rgb , temp_cast_6 , vertexToFrag11_g64816);
				...
				half Final_AlphaFade3727_g64460 = 1.0;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag3890_g64460;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 temp_cast_0 = (dotResult3616_g64460).xxx;
				float4 temp_output_91_19_g64865 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g64460 = packedInput.ase_texcoord2.xyz;
				float3 WorldPosition3905_g64460 = vertexToFrag3890_g64460;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g64460;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag4224_g64460;
					...
					)
			{
				...
				half Main_AlbedoTex_G3526_g64460 = tex2DNode29_g64460.g;
				float4 temp_output_93_19_g64789 = TVE_ExtrasCoords;
				float3 vertexToFrag3890_g64460 = packedInput.ase_texcoord4.xyz;
				float3 WorldPosition3905_g64460 = vertexToFrag3890_g64460;
				float3 vertexToFrag4224_g64460 = packedInput.ase_texcoord5.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g64460;
				half3 WorldData19_g64855 = vertexToFrag3890_g64460;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag3890_g64460;
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag4224_g64460;
				float Mesh_Occlusion318_g64460 = inputMesh.ase_color.g;
				float temp_output_7_0_g64821 = _VertexOcclusionMinValue;
				float temp_output_3377_0_g64460 = saturate( ( ( Mesh_Occlusion318_g64460 - temp_output_7_0_g64821 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g64821 ) ) );
				float vertexToFrag11_g64816 = temp_output_3377_0_g64460;
						...
						)
			{
				...
				float3 temp_cast_0 = (dotResult3616_g64460).xxx;
				float4 temp_output_91_19_g64865 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g64460 = packedInput.ase_texcoord9.xyz;
				float3 WorldPosition3905_g64460 = vertexToFrag3890_g64460;
				float3 vertexToFrag4224_g64460 = packedInput.ase_texcoord10.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g64460;
				half3 WorldData19_g64855 = vertexToFrag3890_g64460;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
...
/*ASEBEGIN
Version=18934
1920;12;1920;1017;3015.488;586.552;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1049;-1920,384;Inherit;False;Define Pipeline HD;-1;;64888;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;713;-2176,384;Inherit;False;Define Shader Grass;-1;;64887;921559c53826c0142ba6e27dd03eaef2;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1050;-1344,-896;Inherit;False;Compile All Shaders;-1;;64889;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1051;-1536,-896;Inherit;False;Compile Core;-1;;64886;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B899D1C908D5CC5FAAB39662F324763FE2F414A6
