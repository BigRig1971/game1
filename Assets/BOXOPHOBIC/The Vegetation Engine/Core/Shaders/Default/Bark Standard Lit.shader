...
Shader "BOXOPHOBIC/The Vegetation Engine/Default/Bark Standard Lit"
{
	Properties
	{
		...
		[ASEEnd][StyledToggle]_MotionValue_20("Use Second Motion Settings", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag4224_g54503 = temp_output_114_0_g64862;
				...
				half Motion_20_Mode162_g54503 = _MotionValue_20;
				half Motion_20_Variation4255_g54503 = ( _MotionVariation_20 * Motion_Variation3073_g54503 );
				half Variation127_g64831 = ( Motion_20_Variation4255_g54503 * Motion_Variation3073_g54503 );
				...
				float temp_output_112_0_g64831 = Global_MotionPower2223_g54503;
				...
				half Motion_Selective4260_g54503 = lerpResult126_g64831;
				half Motion_20_Commons4381_g54503 = ( Mesh_Motion_2060_g54503 * Motion_20_Mode162_g54503 * Motion_Selective4260_g54503 * Global_MotionPower2223_g54503 * Global_MotionNoise34_g54503 );
				half Motion_20_Speed4257_g54503 = _MotionSpeed_20;
				half Input_Speed62_g64832 = Motion_20_Speed4257_g54503;
				float mulTime354_g64832 = _TimeParameters.x * Input_Speed62_g64832;
				float Motion_Variation284_g64832 = Motion_20_Variation4255_g54503;
				half Motion_20_Scale4256_g54503 = _MotionScale_20;
				float Motion_Scale287_g64832 = ( Motion_20_Scale4256_g54503 * ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) );
				half Motion_20_SineWaveA4382_g54503 = sin( ( mulTime354_g64832 + Motion_Variation284_g64832 + Motion_Scale287_g64832 ) );
				half ObjectData20_g64806 = 3.14;
				float Bounds_Radius121_g54503 = _MaxBoundsInfo.x;
				half WorldData19_g64806 = Bounds_Radius121_g54503;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g64806 = WorldData19_g64806;
				#else
				float staticSwitch14_g64806 = ObjectData20_g64806;
				#endif
				float Motion_Max_Rolling1137_g54503 = staticSwitch14_g64806;
				...
				half Angle44_g64810 = Motion_20_Rolling138_g54503;
				half Input_Speed62_g64884 = ( Motion_20_Speed4257_g54503 - 1.0 );
				float mulTime354_g64884 = _TimeParameters.x * Input_Speed62_g64884;
				float Motion_Variation284_g64884 = Motion_20_Variation4255_g54503;
				float Motion_Scale287_g64884 = ( Motion_20_Scale4256_g54503 * ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) );
				half Motion_20_SineWaveB4460_g54503 = sin( ( mulTime354_g64884 + Motion_Variation284_g64884 + Motion_Scale287_g64884 ) );
				...
				float2 break4421_g54503 = ( ( _MotionAmplitude_22 * Motion_20_Commons4381_g54503 * ( Bounds_Radius121_g54503 * 2.0 ) * (Motion_20_SineWaveA4382_g54503*0.2 + 1.0) ) * Global_MotionDirectionOS39_g54503 );
				...
				float3 Vertex_Motion_Object833_g54503 = ( ( VertexPosRotationAxis50_g64810 + ( VertexPosOtherAxis82_g64810 * cos( Angle44_g64810 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g64810 ) * sin( Angle44_g64810 ) ) ) + Motion_20_Vertical4280_g54503 + Motion_20_Squash4418_g54503 );
				...
				half3 Grass_Perspective2661_g54503 = half3(0,0,0);
				...
				float2 appendResult21_g64874 = (float2(inputMesh.ase_texcoord.z , inputMesh.ase_texcoord.w));
				float2 Mesh_DetailCoord3_g54503 = appendResult21_g64874;
				float2 vertexToFrag11_g64813 = ( ( Mesh_DetailCoord3_g54503 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord5.zw = vertexToFrag11_g64813;
				half Mesh_DetailMask90_g54503 = inputMesh.ase_color.b;
				float vertexToFrag11_g64796 = ( ( Mesh_DetailMask90_g54503 - 0.5 ) + _DetailMeshValue );
				...
				float lerpResult4755_g54503 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g64876 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g64876 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g64880 = lerpResult4755_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord8.w = vertexToFrag11_g64880;
						...
						)
			{
				...
				half2 Second_UVs17_g54503 = vertexToFrag11_g64813;
				float4 tex2DNode89_g54503 = tex2D( _SecondAlbedoTex, Second_UVs17_g54503 );
				half3 Second_Albedo153_g54503 = (( _SecondColor * tex2DNode89_g54503 )).rgb;
				float3 lerpResult4834_g54503 = lerp( ( Main_Albedo99_g54503 * Second_Albedo153_g54503 * 4.594794 ) , Second_Albedo153_g54503 , _DetailBlendMode);
				float vertexToFrag11_g64796 = packedInput.ase_texcoord6.x;
				float temp_output_3919_0_g54503 = vertexToFrag11_g64796;
				...
				float staticSwitch4838_g54503 = 0.0;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch4838_g54503 = saturate( ( ( saturate( ( Blend_Source1540_g54503 + ( Blend_Source1540_g54503 * lerpResult4058_g54503 ) ) ) - temp_output_7_0_g64830 ) / ( _DetailBlendMaxValue - temp_output_7_0_g64830 ) ) );
				#else
				float staticSwitch4838_g54503 = 0.0;
				#endif
				half Mask_Detail147_g54503 = staticSwitch4838_g54503;
				float3 lerpResult235_g54503 = lerp( Main_Albedo99_g54503 , lerpResult4834_g54503 , Mask_Detail147_g54503);
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch255_g54503 = Main_Albedo99_g54503;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch255_g54503 = lerpResult235_g54503;
				#else
				float3 staticSwitch255_g54503 = Main_Albedo99_g54503;
				#endif
				...
				half VertexDynamicMode4798_g54503 = _VertexDynamicMode;
				float lerpResult4801_g54503 = lerp( Main_Normal_WS4101_g54503.y , packedInput.ase_normal.y , VertexDynamicMode4798_g54503);
				float lerpResult3567_g54503 = lerp( 0.5 , 1.0 , lerpResult4801_g54503);
				half Main_AlbedoTex_G3526_g54503 = tex2DNode29_g54503.g;
				half Second_AlbedoTex_G3581_g54503 = tex2DNode89_g54503.g;
				...
				half Overlay_Variation4560_g54503 = 1.0;
				...
				half Overlay_Mask269_g54503 = saturate( ( ( ( ( ( lerpResult3567_g54503 * 0.5 ) + staticSwitch3574_g54503 ) * Overlay_Commons1365_g54503 ) - temp_output_7_0_g64869 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g64869 ) ) );
				...
				float3 lerpResult2945_g54503 = lerp( (_VertexOcclusionColor).rgb , temp_cast_3 , vertexToFrag11_g64816);
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch267_g54503 = lerpResult3376_g54503;
				#else
				float3 staticSwitch267_g54503 = Main_Normal137_g54503;
				#endif
				float3 temp_output_13_0_g64811 = staticSwitch267_g54503;
				...
				float3 temp_cast_5 = (( 0.04 * Render_Specular4861_g54503 )).xxx;
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch297_g54503 = lerpResult266_g54503;
				#else
				float staticSwitch297_g54503 = Main_Smoothness227_g54503;
				#endif
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch310_g54503 = lerpResult294_g54503;
				#else
				float staticSwitch310_g54503 = Main_Occlusion247_g54503;
				#endif
				...
				float vertexToFrag11_g64880 = packedInput.ase_texcoord8.w;
				half Fade_Camera3743_g54503 = vertexToFrag11_g64880;
				float temp_output_41_0_g64856 = ( 1.0 * Fade_Camera3743_g54503 );
				half Final_AlphaFade3727_g54503 = saturate( ( temp_output_41_0_g64856 + ( temp_output_41_0_g64856 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g54503 ) ).r ) ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 appendResult21_g64874 = (float2(inputMesh.uv0.z , inputMesh.uv0.w));
				float2 Mesh_DetailCoord3_g54503 = appendResult21_g64874;
				float2 vertexToFrag11_g64813 = ( ( Mesh_DetailCoord3_g54503 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				...
				float temp_output_3377_0_g54503 = saturate( ( ( Mesh_Occlusion318_g54503 - temp_output_7_0_g64821 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g64821 ) ) );
				float vertexToFrag11_g64816 = temp_output_3377_0_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord2.w = vertexToFrag11_g64816;
				...
				float lerpResult4755_g54503 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g64876 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g64876 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g64880 = lerpResult4755_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord3.w = vertexToFrag11_g64880;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half3 Final_Albedo359_g54503 = lerpResult336_g54503;
				float3 temp_cast_3 = (1.0).xxx;
				float vertexToFrag11_g64816 = packedInput.ase_texcoord2.w;
				float3 lerpResult2945_g54503 = lerp( (_VertexOcclusionColor).rgb , temp_cast_3 , vertexToFrag11_g64816);
				float3 Vertex_Occlusion648_g54503 = lerpResult2945_g54503;
				...
				float localCustomAlphaClip9_g64873 = ( 0.0 );
				float vertexToFrag11_g64880 = packedInput.ase_texcoord3.w;
				half Fade_Camera3743_g54503 = vertexToFrag11_g64880;
				float temp_output_41_0_g64856 = ( 1.0 * Fade_Camera3743_g54503 );
				half Final_AlphaFade3727_g54503 = saturate( ( temp_output_41_0_g64856 + ( temp_output_41_0_g64856 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g54503 ) ).r ) ) );
				float Main_Alpha316_g54503 = ( _MainColor.a * tex2DNode29_g54503.a );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag4224_g54503;
					...
					)
			{
				...
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
				float3 vertexToFrag4224_g54503 = packedInput.ase_texcoord6.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g54503;
				half3 WorldData19_g64855 = vertexToFrag3890_g54503;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float temp_output_3377_0_g54503 = saturate( ( ( Mesh_Occlusion318_g54503 - temp_output_7_0_g64821 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g64821 ) ) );
				float vertexToFrag11_g64816 = temp_output_3377_0_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord9.w = vertexToFrag11_g64816;
				...
				float lerpResult4755_g54503 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g64876 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g64876 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g64880 = lerpResult4755_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord10.w = vertexToFrag11_g64880;
						...
						)
			{
				...
				half3 Final_Albedo359_g54503 = lerpResult336_g54503;
				float3 temp_cast_3 = (1.0).xxx;
				float vertexToFrag11_g64816 = packedInput.ase_texcoord9.w;
				float3 lerpResult2945_g54503 = lerp( (_VertexOcclusionColor).rgb , temp_cast_3 , vertexToFrag11_g64816);
				float3 Vertex_Occlusion648_g54503 = lerpResult2945_g54503;
				...
				float localCustomAlphaClip9_g64873 = ( 0.0 );
				float vertexToFrag11_g64880 = packedInput.ase_texcoord10.w;
				half Fade_Camera3743_g54503 = vertexToFrag11_g64880;
				float temp_output_41_0_g64856 = ( 1.0 * Fade_Camera3743_g54503 );
				half Final_AlphaFade3727_g54503 = saturate( ( temp_output_41_0_g64856 + ( temp_output_41_0_g64856 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g54503 ) ).r ) ) );
				float Main_Alpha316_g54503 = ( _MainColor.a * tex2DNode29_g54503.a );
...
/*ASEBEGIN
Version=18934
1920;6;1920;1017;3962.328;1335.91;1.993076;True;False
...
Node;AmplifyShaderEditor.FunctionNode;350;-2176,-384;Inherit;False;Base Shader;0;;54503;856f7164d1c579d43a5cf4968a75ca43;77,3880,1,4029,1,4028,1,4204,1,3900,1,3904,1,3903,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,4499,1,3658,0,1708,0,3509,1,1712,1,3873,1,893,0,4544,1,1718,1,1715,1,1717,1,1714,1,916,1,1762,0,1763,0,3568,1,1949,1,1776,0,3475,1,4210,1,1745,1,3479,0,4510,0,3501,1,3221,2,1646,0,1271,1,3889,0,2807,0,3886,0,2953,0,3887,0,3243,0,3888,0,3957,1,2172,0,3883,0,3728,1,3949,0,4781,0,2658,0,1742,0,3484,0,1737,1,1733,1,1735,1,1736,1,3575,1,4837,1,1734,1,878,0,1550,0,860,1,2260,1,2261,1,2032,1,2054,1,2039,0,2062,0,4177,1,4217,1,3592,1,4242,0,2750,0;0;20;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534;FLOAT;4867;FLOAT4;4841
Node;AmplifyShaderEditor.FunctionNode;307;-2176,384;Inherit;False;Define Shader Vegetation;-1;;64886;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;384;-1536,-896;Inherit;False;Compile Core;-1;;64887;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BD1F78E1633C0A97150AB7DA8E3C70C7314F90F6
