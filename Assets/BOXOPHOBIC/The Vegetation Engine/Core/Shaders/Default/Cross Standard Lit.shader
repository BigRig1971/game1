	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 Vertex_Motion_Object833_g54503 = ( VertexPosRotationAxis50_g64782 + ( VertexPosOtherAxis82_g64782 * cos( Angle44_g64782 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g64782 ) * sin( Angle44_g64782 ) ) );
				...
				half Noise_Tint2802_g54503 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_8 * WorldPosition3905_g54503 * 0.1 ), 0.0) ).r - temp_output_7_0_g64870 ) / ( _NoiseMaxValue - temp_output_7_0_g64870 ) ) );
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag3890_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag4224_g54503;
				
				float2 vertexToFrag11_g64849 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord8.xy = vertexToFrag11_g64849;
						...
						)
			{
				...
				float3 lerpResult4521_g54503 = lerp( float3( 1,1,1 ) , ( lerpResult2779_g54503 * lerpResult2800_g54503 * float3(1,1,1) ) , Leaves_Mask4511_g54503);
				...
				float3 vertexToFrag3890_g54503 = packedInput.ase_texcoord6.xyz;
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
				float3 vertexToFrag4224_g54503 = packedInput.ase_texcoord7.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g54503;
				half3 WorldData19_g64855 = vertexToFrag3890_g54503;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
				...
				half Global_Colors_Mask3692_g54503 = saturate( ( ( Main_Mask57_g54503 - temp_output_7_0_g64858 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g64858 ) ) );
				...
				half Subsurface_Mask1557_g54503 = saturate( ( ( Main_Mask57_g54503 - temp_output_7_0_g64872 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g64872 ) ) );
				...
				half Overlay_Mask269_g54503 = saturate( ( ( ( ( 0.5 + Main_AlbedoTex_G3526_g54503 ) * Overlay_Commons1365_g54503 ) - temp_output_7_0_g64869 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g64869 ) ) );
				...
				float3 temp_cast_7 = (( 0.04 * Render_Specular4861_g54503 )).xxx;
				...
				float2 vertexToFrag11_g64849 = packedInput.ase_texcoord8.xy;
				...
				float lerpResult3992_g54503 = lerp( 1.0 , saturate( abs( dotResult2161_g54503 ) ) , lerpResult2221_g54503);
				half Fade_Billboard2175_g54503 = lerpResult3992_g54503;
				float temp_output_41_0_g64856 = ( 1.0 * Fade_Billboard2175_g54503 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag4224_g54503;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord4.xy = vertexToFrag11_g64849;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
				float3 vertexToFrag4224_g54503 = packedInput.ase_texcoord2.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g54503;
				half3 WorldData19_g64855 = vertexToFrag3890_g54503;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
				...
				float3 hdEmission4189_g54503 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g64849 = packedInput.ase_texcoord4.xy;
				half2 Emissive_UVs2468_g54503 = vertexToFrag11_g64849;
				half Global_Extras_Emissive4203_g54503 = break89_g64789.r;
				float lerpResult4206_g54503 = lerp( 1.0 , Global_Extras_Emissive4203_g54503 , _GlobalEmissive);
				half3 Final_Emissive2476_g54503 = ( (( hdEmission4189_g54503 * tex2D( _EmissiveTex, Emissive_UVs2468_g54503 ) )).rgb * lerpResult4206_g54503 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag4224_g54503;
				
				float2 vertexToFrag11_g64849 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord10.xy = vertexToFrag11_g64849;
						...
						)
			{
				...
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
				float3 vertexToFrag4224_g54503 = packedInput.ase_texcoord9.xyz;
				half3 ObjectData20_g64855 = vertexToFrag4224_g54503;
				half3 WorldData19_g64855 = vertexToFrag3890_g54503;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g64855 = WorldData19_g64855;
				...
				float3 hdEmission4189_g54503 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g64849 = packedInput.ase_texcoord10.xy;
				half2 Emissive_UVs2468_g54503 = vertexToFrag11_g64849;
				half Global_Extras_Emissive4203_g54503 = break89_g64789.r;
				float lerpResult4206_g54503 = lerp( 1.0 , Global_Extras_Emissive4203_g54503 , _GlobalEmissive);
				half3 Final_Emissive2476_g54503 = ( (( hdEmission4189_g54503 * tex2D( _EmissiveTex, Emissive_UVs2468_g54503 ) )).rgb * lerpResult4206_g54503 );
...
/*ASEBEGIN
Version=18934
1920;12;1920;1017;3214.946;544.4545;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;129;-1984,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;203;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;320;-1856,384;Inherit;False;Define Pipeline HD;-1;;64887;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
...
ASEEND*/
//CHKSM=B428EF2572F987879BBD4F5CAD402AB1751BD5DA
