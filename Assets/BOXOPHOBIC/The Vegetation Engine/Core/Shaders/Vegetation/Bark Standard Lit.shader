	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 Mesh_PivotsOS2291_g54503 = half3(0,0,0);
				...
				float3 vertexToFrag4224_g54503 = temp_output_114_0_g56500;
				...
				half Motion_20_Mode4258_g54503 = _VertexRollingMode;
				half Mesh_Motion_2060_g54503 = inputMesh.ase_texcoord3.y;
				float lerpResult410_g56517 = lerp( TVE_MotionParamsMin.y , TVE_MotionParamsMax.y , Wind_Power369_g56517);
				half Wind_Power_203109_g54503 = lerpResult410_g56517;
				half Motion_20_Variation4255_g54503 = ( _MotionVariation_20 * Motion_Variation3073_g54503 );
				half Variation127_g56497 = ( Motion_20_Variation4255_g54503 * Motion_Variation3073_g54503 );
				...
				float temp_output_112_0_g56497 = Wind_Power2223_g54503;
				...
				half Motion_Selective4260_g54503 = lerpResult126_g56497;
				half Motion_20_Commons4381_g54503 = ( Motion_20_Mode4258_g54503 * Mesh_Motion_2060_g54503 * Wind_Power_203109_g54503 * Global_NoiseTex_R34_g54503 * Motion_Selective4260_g54503 );
				half Motion_20_Speed4257_g54503 = _MotionSpeed_20;
				half Input_Speed62_g56498 = Motion_20_Speed4257_g54503;
				float mulTime354_g56498 = _TimeParameters.x * Input_Speed62_g56498;
				float Motion_Variation284_g56498 = Motion_20_Variation4255_g54503;
				half Motion_20_Scale4256_g54503 = _MotionScale_20;
				float Motion_Scale287_g56498 = ( Motion_20_Scale4256_g54503 * ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) );
				half Motion_20_SineWaveA4382_g54503 = sin( ( mulTime354_g56498 + Motion_Variation284_g56498 + Motion_Scale287_g56498 ) );
				half ObjectData20_g56485 = 3.14;
				float Bounds_Radius121_g54503 = _MaxBoundsInfo.x;
				half WorldData19_g56485 = Bounds_Radius121_g54503;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g56485 = WorldData19_g56485;
				#else
				float staticSwitch14_g56485 = ObjectData20_g56485;
				#endif
				float Motion_Max_Rolling1137_g54503 = staticSwitch14_g56485;
				half Motion_20_Rolling138_g54503 = ( _MotionAmplitude_20 * Motion_20_Commons4381_g54503 * Motion_20_SineWaveA4382_g54503 * Motion_Max_Rolling1137_g54503 );
				half Angle44_g56481 = Motion_20_Rolling138_g54503;
				half Input_Speed62_g56457 = ( Motion_20_Speed4257_g54503 - 1.0 );
				float mulTime354_g56457 = _TimeParameters.x * Input_Speed62_g56457;
				float Motion_Variation284_g56457 = Motion_20_Variation4255_g54503;
				float Motion_Scale287_g56457 = ( Motion_20_Scale4256_g54503 * ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) );
				half Motion_20_SineWaveB4460_g54503 = sin( ( mulTime354_g56457 + Motion_Variation284_g56457 + Motion_Scale287_g56457 ) );
				float3 appendResult4393_g54503 = (float3(0.0 , ( _MotionAmplitude_21 * Motion_20_Commons4381_g54503 * Motion_20_SineWaveB4460_g54503 * Bounds_Radius121_g54503 ) , 0.0));
				half3 Motion_20_Vertical4280_g54503 = appendResult4393_g54503;
				float2 break4421_g54503 = ( ( _MotionAmplitude_22 * Motion_20_Commons4381_g54503 * ( Bounds_Radius121_g54503 * 2.0 ) * (Motion_20_SineWaveA4382_g54503*Wind_Squash4479_g54503 + 1.0) ) * Wind_DirectionOS39_g54503 );
				float3 appendResult4417_g54503 = (float3(break4421_g54503.x , 0.0 , break4421_g54503.y));
				half3 Motion_20_Squash4418_g54503 = appendResult4417_g54503;
				float3 Vertex_Motion_Object833_g54503 = ( ( VertexPosRotationAxis50_g56481 + ( VertexPosOtherAxis82_g56481 * cos( Angle44_g56481 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g56481 ) * sin( Angle44_g56481 ) ) ) + Motion_20_Vertical4280_g54503 + Motion_20_Squash4418_g54503 );
				...
				float3 appendResult2047_g54503 = (float3(Motion_20_Rolling138_g54503 , 0.0 , -Motion_20_Rolling138_g54503));
				float3 Vertex_Motion_World1118_g54503 = ( ( temp_output_3474_0_g54503 + appendResult2043_g54503 ) + appendResult2047_g54503 + Motion_20_Vertical4280_g54503 + Motion_20_Squash4418_g54503 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				float3 Vertex_SizeFade1740_g54503 = _Vector5;
				half3 Grass_Coverage2661_g54503 = half3(0,0,0);
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5.xy = vertexToFrag11_g56515;
				float2 appendResult21_g56459 = (float2(inputMesh.ase_texcoord.z , inputMesh.ase_texcoord.w));
				float2 Mesh_DetailCoord3_g54503 = appendResult21_g56459;
				float2 vertexToFrag11_g56505 = ( ( Mesh_DetailCoord3_g54503 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord5.zw = vertexToFrag11_g56505;
				half Mesh_DetailMask90_g54503 = inputMesh.ase_color.b;
				float vertexToFrag11_g56471 = ( ( Mesh_DetailMask90_g54503 - 0.5 ) + _DetailMeshValue );
				outputPackedVaryingsMeshToPS.ase_texcoord6.x = vertexToFrag11_g56471;
				...
				float3 lerpResult2945_g54503 = lerp( (_VertexOcclusionColor).rgb , temp_cast_11 , saturate( ( ( Mesh_Occlusion318_g54503 - temp_output_7_0_g56463 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g56463 ) ) ));
				...
				outputPackedVaryingsMeshToPS.ase_texcoord9.xy = vertexToFrag11_g56467;
				
				float temp_output_7_0_g56513 = TVE_CameraFadeStart;
				float saferPower3976_g54503 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g56513 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g56513 ) ) ) , 0.0001 );
				float temp_output_3976_0_g54503 = pow( saferPower3976_g54503 , _FadeCameraValue );
				float vertexToFrag11_g56491 = temp_output_3976_0_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = vertexToFrag11_g56491;
						...
						)
			{
				...
				float3 lerpResult4521_g54503 = lerp( float3( 1,1,1 ) , ( float3(1,1,1) * float3(1,1,1) * float3(1,1,1) ) , Leaves_Mask4511_g54503);
				float3 lerpResult4519_g54503 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g54503);
				float2 vertexToFrag11_g56515 = packedInput.ase_texcoord5.xy;
				...
				float2 vertexToFrag11_g56505 = packedInput.ase_texcoord5.zw;
				half2 Second_UVs17_g54503 = vertexToFrag11_g56505;
				half3 Second_Albedo153_g54503 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g54503 ) )).rgb;
				float vertexToFrag11_g56471 = packedInput.ase_texcoord6.x;
				float temp_output_3919_0_g54503 = vertexToFrag11_g56471;
				half Blend_Source1540_g54503 = temp_output_3919_0_g54503;
				float4 tex2DNode35_g54503 = tex2D( _MainMaskTex, Main_UVs15_g54503 );
				half Main_Mask57_g54503 = tex2DNode35_g54503.b;
				float4 tex2DNode33_g54503 = tex2D( _SecondMaskTex, Second_UVs17_g54503 );
				half Second_Mask81_g54503 = tex2DNode33_g54503.b;
				float lerpResult1327_g54503 = lerp( Main_Mask57_g54503 , Second_Mask81_g54503 , _DetailMaskMode);
				float lerpResult4058_g54503 = lerp( lerpResult1327_g54503 , ( 1.0 - lerpResult1327_g54503 ) , _DetailMaskInvertMode);
				float temp_output_7_0_g56466 = _DetailBlendMinValue;
				half Mask_Detail147_g54503 = saturate( ( ( saturate( ( Blend_Source1540_g54503 + ( Blend_Source1540_g54503 * lerpResult4058_g54503 ) ) ) - temp_output_7_0_g56466 ) / ( _DetailBlendMaxValue - temp_output_7_0_g56466 ) ) );
				float3 lerpResult235_g54503 = lerp( Main_Albedo99_g54503 , ( Main_Albedo99_g54503 * Second_Albedo153_g54503 * 4.594794 ) , Mask_Detail147_g54503);
				float3 lerpResult208_g54503 = lerp( Main_Albedo99_g54503 , Second_Albedo153_g54503 , Mask_Detail147_g54503);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4062_g54503 = lerpResult235_g54503;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4062_g54503 = lerpResult208_g54503;
				#else
				float3 staticSwitch4062_g54503 = lerpResult235_g54503;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch255_g54503 = Main_Albedo99_g54503;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch255_g54503 = staticSwitch4062_g54503;
				#else
				float3 staticSwitch255_g54503 = Main_Albedo99_g54503;
				#endif
				half3 Blend_Albedo265_g54503 = staticSwitch255_g54503;
				half3 Blend_AlbedoTinted2808_g54503 = ( lerpResult4521_g54503 * Blend_Albedo265_g54503 );
				half3 Blend_AlbedoColored863_g54503 = Blend_AlbedoTinted2808_g54503;
				half3 Blend_AlbedoAndSubsurface149_g54503 = Blend_AlbedoColored863_g54503;
				...
				float3 tanNormal4099_g54503 = Main_Normal137_g54503;
				float3 worldNormal4099_g54503 = float3(dot(tanToWorld0,tanNormal4099_g54503), dot(tanToWorld1,tanNormal4099_g54503), dot(tanToWorld2,tanNormal4099_g54503));
				float3 Main_Normal_WS4101_g54503 = worldNormal4099_g54503;
				float lerpResult3567_g54503 = lerp( _OverlayBottomValue , 1.0 , Main_Normal_WS4101_g54503.y);
				half Main_AlbedoTex_G3526_g54503 = tex2DNode29_g54503.g;
				half Second_AlbedoTex_G3581_g54503 = (tex2D( _SecondAlbedoTex, Second_UVs17_g54503 )).g;
				float lerpResult3579_g54503 = lerp( Main_AlbedoTex_G3526_g54503 , Second_AlbedoTex_G3581_g54503 , Mask_Detail147_g54503);
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch3574_g54503 = Main_AlbedoTex_G3526_g54503;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch3574_g54503 = lerpResult3579_g54503;
				#else
				float staticSwitch3574_g54503 = Main_AlbedoTex_G3526_g54503;
				#endif
				...
				half Overlay_Commons1365_g54503 = temp_output_1025_0_g54503;
				float temp_output_7_0_g56499 = _OverlayMaskMinValue;
				half Overlay_Mask269_g54503 = saturate( ( ( ( ( ( lerpResult3567_g54503 * 0.5 ) + staticSwitch3574_g54503 ) * Overlay_Commons1365_g54503 ) - temp_output_7_0_g56499 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g56499 ) ) );
				...
				float3 unpack4114_g54503 = UnpackNormalScale( tex2D( _SecondNormalTex, Second_UVs17_g54503 ), _SecondNormalValue );
				unpack4114_g54503.z = lerp( 1, unpack4114_g54503.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g54503 = unpack4114_g54503;
				float3 lerpResult230_g54503 = lerp( float3( 0,0,1 ) , Second_Normal179_g54503 , Mask_Detail147_g54503);
				float3 lerpResult3372_g54503 = lerp( float3( 0,0,1 ) , Main_Normal137_g54503 , _DetailNormalValue);
				float3 lerpResult3376_g54503 = lerp( Main_Normal137_g54503 , BlendNormal( lerpResult3372_g54503 , Second_Normal179_g54503 ) , Mask_Detail147_g54503);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4063_g54503 = BlendNormal( Main_Normal137_g54503 , lerpResult230_g54503 );
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4063_g54503 = lerpResult3376_g54503;
				#else
				float3 staticSwitch4063_g54503 = BlendNormal( Main_Normal137_g54503 , lerpResult230_g54503 );
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch267_g54503 = Main_Normal137_g54503;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch267_g54503 = staticSwitch4063_g54503;
				#else
				float3 staticSwitch267_g54503 = Main_Normal137_g54503;
				#endif
				float3 temp_output_13_0_g56506 = staticSwitch267_g54503;
				...
				float2 vertexToFrag11_g56467 = packedInput.ase_texcoord9.xy;
				...
				half Second_Smoothness236_g54503 = ( tex2DNode33_g54503.a * _SecondSmoothnessValue );
				float lerpResult266_g54503 = lerp( Main_Smoothness227_g54503 , Second_Smoothness236_g54503 , Mask_Detail147_g54503);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4065_g54503 = Main_Smoothness227_g54503;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4065_g54503 = lerpResult266_g54503;
				#else
				float staticSwitch4065_g54503 = Main_Smoothness227_g54503;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch297_g54503 = Main_Smoothness227_g54503;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch297_g54503 = staticSwitch4065_g54503;
				#else
				float staticSwitch297_g54503 = Main_Smoothness227_g54503;
				#endif
				half Blend_Smoothness314_g54503 = staticSwitch297_g54503;
				...
				float lerpResult239_g54503 = lerp( 1.0 , tex2DNode33_g54503.g , _SecondOcclusionValue);
				half Second_Occlusion251_g54503 = lerpResult239_g54503;
				float lerpResult294_g54503 = lerp( Main_Occlusion247_g54503 , Second_Occlusion251_g54503 , Mask_Detail147_g54503);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4066_g54503 = Main_Occlusion247_g54503;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4066_g54503 = lerpResult294_g54503;
				#else
				float staticSwitch4066_g54503 = Main_Occlusion247_g54503;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch310_g54503 = Main_Occlusion247_g54503;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch310_g54503 = staticSwitch4066_g54503;
				#else
				float staticSwitch310_g54503 = Main_Occlusion247_g54503;
				#endif
				half Blend_Occlusion323_g54503 = staticSwitch310_g54503;
				
				float localCustomAlphaClip3735_g54503 = ( 0.0 );
				float vertexToFrag11_g56491 = packedInput.ase_texcoord7.w;
				half Fade_Camera3743_g54503 = vertexToFrag11_g56491;
				half Final_AlphaFade3727_g54503 = ( 1.0 * Fade_Camera3743_g54503 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g54503;
				float Main_Alpha316_g54503 = ( _MainColor.a * tex2DNode29_g54503.a );
				half AlphaTreshold2132_g54503 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g54503 = ( Main_Alpha316_g54503 - ( AlphaTreshold2132_g54503 - 0.5 ) );
				#else
				float staticSwitch3792_g54503 = Main_Alpha316_g54503;
				#endif
				half Final_Alpha3754_g54503 = staticSwitch3792_g54503;
				float temp_output_661_0_g54503 = ( saturate( ( temp_output_41_0_g56470 + ( temp_output_41_0_g56470 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g54503 ) ).r ) ) ) * Final_Alpha3754_g54503 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord.xy = vertexToFrag11_g56515;
				float2 appendResult21_g56459 = (float2(inputMesh.uv0.z , inputMesh.uv0.w));
				float2 Mesh_DetailCoord3_g54503 = appendResult21_g56459;
				float2 vertexToFrag11_g56505 = ( ( Mesh_DetailCoord3_g54503 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord.zw = vertexToFrag11_g56505;
				half Mesh_DetailMask90_g54503 = inputMesh.ase_color.b;
				float vertexToFrag11_g56471 = ( ( Mesh_DetailMask90_g54503 - 0.5 ) + _DetailMeshValue );
				outputPackedVaryingsMeshToPS.ase_texcoord1.x = vertexToFrag11_g56471;
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				...
				float3 lerpResult2945_g54503 = lerp( (_VertexOcclusionColor).rgb , temp_cast_11 , saturate( ( ( Mesh_Occlusion318_g54503 - temp_output_7_0_g56463 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g56463 ) ) ));
				float3 vertexToFrag11_g56482 = lerpResult2945_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag11_g56482;
				
				float2 vertexToFrag11_g56467 = ( ( inputMesh.uv0.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord6.xy = vertexToFrag11_g56467;
				
				float temp_output_7_0_g56513 = TVE_CameraFadeStart;
				float saferPower3976_g54503 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g56513 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g56513 ) ) ) , 0.0001 );
				float temp_output_3976_0_g54503 = pow( saferPower3976_g54503 , _FadeCameraValue );
				float vertexToFrag11_g56491 = temp_output_3976_0_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord2.w = vertexToFrag11_g56491;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 lerpResult4521_g54503 = lerp( float3( 1,1,1 ) , ( float3(1,1,1) * float3(1,1,1) * float3(1,1,1) ) , Leaves_Mask4511_g54503);
				float3 lerpResult4519_g54503 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g54503);
				float2 vertexToFrag11_g56515 = packedInput.ase_texcoord.xy;
				half2 Main_UVs15_g54503 = vertexToFrag11_g56515;
				float4 tex2DNode29_g54503 = tex2D( _MainAlbedoTex, Main_UVs15_g54503 );
				half3 Main_Albedo99_g54503 = ( lerpResult4519_g54503 * (tex2DNode29_g54503).rgb );
				float2 vertexToFrag11_g56505 = packedInput.ase_texcoord.zw;
				half2 Second_UVs17_g54503 = vertexToFrag11_g56505;
				half3 Second_Albedo153_g54503 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g54503 ) )).rgb;
				float vertexToFrag11_g56471 = packedInput.ase_texcoord1.x;
				float temp_output_3919_0_g54503 = vertexToFrag11_g56471;
				half Blend_Source1540_g54503 = temp_output_3919_0_g54503;
				float4 tex2DNode35_g54503 = tex2D( _MainMaskTex, Main_UVs15_g54503 );
				half Main_Mask57_g54503 = tex2DNode35_g54503.b;
				...
				float3 lerpResult336_g54503 = lerp( Blend_AlbedoAndSubsurface149_g54503 , Global_OverlayColor1758_g54503 , Overlay_Mask269_g54503);
				half3 Final_Albedo359_g54503 = lerpResult336_g54503;
				float3 vertexToFrag11_g56482 = packedInput.ase_texcoord5.xyz;
				float3 Vertex_Occlusion648_g54503 = saturate( vertexToFrag11_g56482 );
				...
				float3 hdEmission4189_g54503 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g56467 = packedInput.ase_texcoord6.xy;
				half2 Emissive_UVs2468_g54503 = vertexToFrag11_g56467;
				half Global_Extras_Emissive4203_g54503 = break89_g56460.r;
				float lerpResult4206_g54503 = lerp( 1.0 , Global_Extras_Emissive4203_g54503 , _GlobalEmissive);
				half3 Final_Emissive2476_g54503 = ( (( hdEmission4189_g54503 * tex2D( _EmissiveTex, Emissive_UVs2468_g54503 ) )).rgb * lerpResult4206_g54503 );
				...
				float localCustomAlphaClip3735_g54503 = ( 0.0 );
				float vertexToFrag11_g56491 = packedInput.ase_texcoord2.w;
				half Fade_Camera3743_g54503 = vertexToFrag11_g56491;
				half Final_AlphaFade3727_g54503 = ( 1.0 * Fade_Camera3743_g54503 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g54503;
				float Main_Alpha316_g54503 = ( _MainColor.a * tex2DNode29_g54503.a );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord1.yzw = vertexToFrag3890_g54503;
				float2 vertexToFrag11_g56515 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					...
					)
			{
				...
				half Final_AlphaFade3727_g54503 = ( 1.0 * Fade_Camera3743_g54503 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g54503;
				float3 vertexToFrag3890_g54503 = packedInput.ase_texcoord1.yzw;
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 Mesh_DetailCoord3_g54503 = appendResult21_g56459;
				float2 vertexToFrag11_g56505 = ( ( Mesh_DetailCoord3_g54503 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord3.zw = vertexToFrag11_g56505;
				half Mesh_DetailMask90_g54503 = inputMesh.ase_color.b;
				float vertexToFrag11_g56471 = ( ( Mesh_DetailMask90_g54503 - 0.5 ) + _DetailMeshValue );
				outputPackedVaryingsMeshToPS.ase_texcoord4.x = vertexToFrag11_g56471;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag3890_g54503;
				
				float temp_output_7_0_g56513 = TVE_CameraFadeStart;
				float saferPower3976_g54503 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g56513 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g56513 ) ) ) , 0.0001 );
				float temp_output_3976_0_g54503 = pow( saferPower3976_g54503 , _FadeCameraValue );
				float vertexToFrag11_g56491 = temp_output_3976_0_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = vertexToFrag11_g56491;
					...
					)
			{
				...
				unpack4112_g54503.z = lerp( 1, unpack4112_g54503.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g54503 = unpack4112_g54503;
				float2 vertexToFrag11_g56505 = packedInput.ase_texcoord3.zw;
				half2 Second_UVs17_g54503 = vertexToFrag11_g56505;
				float3 unpack4114_g54503 = UnpackNormalScale( tex2D( _SecondNormalTex, Second_UVs17_g54503 ), _SecondNormalValue );
				unpack4114_g54503.z = lerp( 1, unpack4114_g54503.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g54503 = unpack4114_g54503;
				float vertexToFrag11_g56471 = packedInput.ase_texcoord4.x;
				float temp_output_3919_0_g54503 = vertexToFrag11_g56471;
				half Blend_Source1540_g54503 = temp_output_3919_0_g54503;
				float4 tex2DNode35_g54503 = tex2D( _MainMaskTex, Main_UVs15_g54503 );
				half Main_Mask57_g54503 = tex2DNode35_g54503.b;
				...
				float staticSwitch3574_g54503 = Main_AlbedoTex_G3526_g54503;
				#endif
				float3 vertexToFrag3890_g54503 = packedInput.ase_texcoord5.xyz;
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
				float3 Position82_g56460 = WorldPosition3905_g54503;
				float temp_output_84_0_g56460 = _LayerExtrasValue;
				float4 lerpResult88_g56460 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g56460).xz ) ),temp_output_84_0_g56460 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g56460]);
				...
				float localCustomAlphaClip3735_g54503 = ( 0.0 );
				float vertexToFrag11_g56491 = packedInput.ase_texcoord5.w;
				half Fade_Camera3743_g54503 = vertexToFrag11_g56491;
				half Final_AlphaFade3727_g54503 = ( 1.0 * Fade_Camera3743_g54503 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g54503;
				float Main_Alpha316_g54503 = ( _MainColor.a * tex2DNode29_g54503.a );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float2 Mesh_DetailCoord3_g54503 = appendResult21_g56459;
				float2 vertexToFrag11_g56505 = ( ( Mesh_DetailCoord3_g54503 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord7.zw = vertexToFrag11_g56505;
				half Mesh_DetailMask90_g54503 = inputMesh.ase_color.b;
				float vertexToFrag11_g56471 = ( ( Mesh_DetailMask90_g54503 - 0.5 ) + _DetailMeshValue );
				outputPackedVaryingsMeshToPS.ase_texcoord8.x = vertexToFrag11_g56471;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				float ase_vertexTangentSign = inputMesh.tangentOS.w * unity_WorldTransformParams.w;
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
				...
				float2 vertexToFrag11_g56467 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord11.xy = vertexToFrag11_g56467;
				
				float temp_output_7_0_g56513 = TVE_CameraFadeStart;
				float saferPower3976_g54503 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g56513 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g56513 ) ) ) , 0.0001 );
				float temp_output_3976_0_g54503 = pow( saferPower3976_g54503 , _FadeCameraValue );
				float vertexToFrag11_g56491 = temp_output_3976_0_g54503;
				outputPackedVaryingsMeshToPS.ase_texcoord9.w = vertexToFrag11_g56491;
						...
						)
			{
				...
				float4 tex2DNode29_g54503 = tex2D( _MainAlbedoTex, Main_UVs15_g54503 );
				half3 Main_Albedo99_g54503 = ( lerpResult4519_g54503 * (tex2DNode29_g54503).rgb );
				float2 vertexToFrag11_g56505 = packedInput.ase_texcoord7.zw;
				half2 Second_UVs17_g54503 = vertexToFrag11_g56505;
				half3 Second_Albedo153_g54503 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g54503 ) )).rgb;
				float vertexToFrag11_g56471 = packedInput.ase_texcoord8.x;
				float temp_output_3919_0_g54503 = vertexToFrag11_g56471;
				half Blend_Source1540_g54503 = temp_output_3919_0_g54503;
				float4 tex2DNode35_g54503 = tex2D( _MainMaskTex, Main_UVs15_g54503 );
				half Main_Mask57_g54503 = tex2DNode35_g54503.b;
				...
				float3 hdEmission4189_g54503 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g56467 = packedInput.ase_texcoord11.xy;
				half2 Emissive_UVs2468_g54503 = vertexToFrag11_g56467;
				half Global_Extras_Emissive4203_g54503 = break89_g56460.r;
				float lerpResult4206_g54503 = lerp( 1.0 , Global_Extras_Emissive4203_g54503 , _GlobalEmissive);
				half3 Final_Emissive2476_g54503 = ( (( hdEmission4189_g54503 * tex2D( _EmissiveTex, Emissive_UVs2468_g54503 ) )).rgb * lerpResult4206_g54503 );
				...
				float localCustomAlphaClip3735_g54503 = ( 0.0 );
				float vertexToFrag11_g56491 = packedInput.ase_texcoord9.w;
				half Fade_Camera3743_g54503 = vertexToFrag11_g56491;
				half Final_AlphaFade3727_g54503 = ( 1.0 * Fade_Camera3743_g54503 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g54503;
				float Main_Alpha316_g54503 = ( _MainColor.a * tex2DNode29_g54503.a );
...
/*ASEBEGIN
Version=18912
1920;0;1920;1029;3507.907;883.4805;1.993076;True;False
...
Node;AmplifyShaderEditor.FunctionNode;382;-1856,384;Inherit;False;Define Pipeline HD;-1;;54501;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
...
Node;AmplifyShaderEditor.FunctionNode;383;-1344,-896;Inherit;False;Compile All Shaders;-1;;54502;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;350;-2176,-384;Inherit;False;Base Shader;0;;54503;856f7164d1c579d43a5cf4968a75ca43;81,3880,1,3882,1,3957,1,4029,1,4028,1,3900,1,4204,1,3904,1,3903,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,4499,1,1708,0,3658,0,3509,1,1712,1,3873,1,1718,1,1714,1,1715,1,1717,1,916,1,1762,0,1763,0,3568,1,1949,1,1776,0,3475,1,4210,1,893,0,1745,1,3479,0,4510,0,3501,1,3221,2,1646,0,1757,0,1271,1,3889,0,2807,0,3886,0,2953,0,3887,0,3243,0,3888,0,3728,1,3949,0,2172,0,3883,0,2658,0,1742,0,3484,0,1734,1,1737,1,1735,1,1733,1,1736,1,3575,1,878,0,1550,0,4072,0,4067,0,4070,0,4069,0,4068,0,860,1,2260,1,2261,1,2054,1,2032,1,2039,0,2062,0,4177,1,4217,1,3592,1,2750,0,4242,0;0;20;FLOAT;4528;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4135;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4127;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534
Node;AmplifyShaderEditor.FunctionNode;307;-2176,384;Inherit;False;Define Shader Vegetation;-1;;56520;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;384;-1536,-896;Inherit;False;Compile Core;-1;;56521;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=72D3B3042E4864ACCB2A3511020C6E35C6D19A34
