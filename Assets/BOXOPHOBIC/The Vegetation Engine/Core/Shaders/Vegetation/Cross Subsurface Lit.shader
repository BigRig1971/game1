	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 VertexPosition3588_g56248 = inputMesh.positionOS;
				half3 Mesh_PivotsOS2291_g56248 = half3(0,0,0);
				float3 temp_output_2283_0_g56248 = ( VertexPosition3588_g56248 - Mesh_PivotsOS2291_g56248 );
				half3 VertexPos40_g56507 = temp_output_2283_0_g56248;
				...
				float Bounds_Height374_g56248 = _MaxBoundsInfo.y;
				half WorldData19_g56472 = ( Bounds_Height374_g56248 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g56472 = WorldData19_g56472;
				#else
				float staticSwitch14_g56472 = ObjectData20_g56472;
				#endif
				float Motion_Max_Bending1133_g56248 = staticSwitch14_g56472;
				...
				float3 vertexToFrag4224_g56248 = temp_output_114_0_g56500;
				half3 ObjectData20_g56464 = vertexToFrag4224_g56248;
				float3 vertexToFrag3890_g56248 = ase_worldPos;
				half3 WorldData19_g56464 = vertexToFrag3890_g56248;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g56464 = WorldData19_g56464;
				#else
				float3 staticSwitch14_g56464 = ObjectData20_g56464;
				#endif
				float3 ObjectPosition4223_g56248 = staticSwitch14_g56464;
				float3 Position83_g56474 = ObjectPosition4223_g56248;
				...
				half4 Global_Motion_Params3909_g56248 = lerpResult87_g56474;
				float4 break322_g56517 = Global_Motion_Params3909_g56248;
				...
				half Wind_Power_103106_g56248 = lerpResult376_g56517;
				float2 panner73_g56487 = ( _TimeParameters.x * (TVE_NoiseParams).xy + ( (ObjectPosition4223_g56248).xz * TVE_NoiseParams.z ));
				...
				half Wind_Power2223_g56248 = Wind_Power369_g56517;
				float temp_output_167_0_g56487 = Wind_Power2223_g56248;
				...
				half Global_NoiseTex_R34_g56248 = break174_g56487.r;
				...
				half2 Wind_DirectionOS39_g56248 = (temp_output_339_0_g56517).xz;
				half Input_Speed62_g56504 = _MotionSpeed_10;
				float mulTime373_g56504 = _TimeParameters.x * Input_Speed62_g56504;
				float3 break111_g56453 = ObjectPosition4223_g56248;
				...
				#endif
				half Motion_Variation3073_g56248 = staticSwitch14_g56454;
				half Motion_Variation284_g56504 = ( _MotionVariation_10 * Motion_Variation3073_g56248 );
				...
				half Wind_Squash4479_g56248 = break322_g56517.w;
				half Input_WindSquash419_g56504 = Wind_Squash4479_g56248;
				half Input_WindPower327_g56504 = Wind_Power_103106_g56248;
				...
				half Mesh_Motion_1082_g56248 = inputMesh.ase_texcoord3.x;
				half2 Motion_10_Bending2258_g56248 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g56248 ) * Wind_Power_103106_g56248 * Global_NoiseTex_R34_g56248 * Wind_DirectionOS39_g56248 * lerpResult321_g56504 * Mesh_Motion_1082_g56248 );
				half Interaction_Amplitude4137_g56248 = _InteractionAmplitude;
				float3 Position83_g56496 = ObjectPosition4223_g56248;
				...
				half4 Global_React_Params4173_g56248 = lerpResult87_g56496;
				float4 break322_g56492 = Global_React_Params4173_g56248;
				half Interaction_Mask66_g56248 = break322_g56492.z;
				...
				half2 Interaction_DirectionOS4158_g56248 = (temp_output_339_0_g56492).xz;
				float lerpResult4494_g56248 = lerp( 1.0 , Mesh_Motion_1082_g56248 , _InteractionMaskValue);
				half2 Motion_10_Interaction53_g56248 = ( Interaction_Amplitude4137_g56248 * Motion_Max_Bending1133_g56248 * Interaction_Mask66_g56248 * Interaction_Mask66_g56248 * Interaction_DirectionOS4158_g56248 * lerpResult4494_g56248 );
				float2 lerpResult109_g56248 = lerp( Motion_10_Bending2258_g56248 , Motion_10_Interaction53_g56248 , ( Interaction_Mask66_g56248 * saturate( Interaction_Amplitude4137_g56248 ) ));
				float2 break143_g56248 = lerpResult109_g56248;
				half Motion_10_ZAxis190_g56248 = break143_g56248.y;
				half Angle44_g56507 = Motion_10_ZAxis190_g56248;
				...
				half Motion_10_XAxis216_g56248 = break143_g56248.x;
				half Angle44_g56511 = -Motion_10_XAxis216_g56248;
				float3 Vertex_Motion_Object833_g56248 = ( VertexPosRotationAxis50_g56511 + ( VertexPosOtherAxis82_g56511 * cos( Angle44_g56511 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g56511 ) * sin( Angle44_g56511 ) ) );
				float3 temp_output_3474_0_g56248 = ( VertexPosition3588_g56248 - Mesh_PivotsOS2291_g56248 );
				float3 appendResult2043_g56248 = (float3(Motion_10_XAxis216_g56248 , 0.0 , Motion_10_ZAxis190_g56248));
				float3 Vertex_Motion_World1118_g56248 = ( temp_output_3474_0_g56248 + appendResult2043_g56248 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch3312_g56248 = Vertex_Motion_World1118_g56248;
				#else
				float3 staticSwitch3312_g56248 = ( Vertex_Motion_Object833_g56248 + ( 0.0 * _VertexDataMode ) );
				#endif
				half Global_Vertex_Size174_g56248 = break322_g56492.w;
				float lerpResult346_g56248 = lerp( 1.0 , Global_Vertex_Size174_g56248 , _GlobalSize);
				float3 appendResult3480_g56248 = (float3(lerpResult346_g56248 , lerpResult346_g56248 , lerpResult346_g56248));
				half3 ObjectData20_g56469 = appendResult3480_g56248;
				...
				#endif
				half3 Vertex_Size1741_g56248 = staticSwitch14_g56469;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g56248 = _Vector5;
				half3 Grass_Coverage2661_g56248 = half3(0,0,0);
				float3 Final_VertexPosition890_g56248 = ( ( ( staticSwitch3312_g56248 * Vertex_Size1741_g56248 * Vertex_SizeFade1740_g56248 ) + Mesh_PivotsOS2291_g56248 + Grass_Coverage2661_g56248 ) + _DisableSRPBatcher );
				
				float temp_output_7_0_g56494 = _GradientMinValue;
				float4 lerpResult2779_g56248 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( inputMesh.ase_color.a - temp_output_7_0_g56494 ) / ( _GradientMaxValue - temp_output_7_0_g56494 ) ) ));
				half3 Gradient_Tint2784_g56248 = (lerpResult2779_g56248).rgb;
				float3 vertexToFrag11_g56476 = Gradient_Tint2784_g56248;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag11_g56476;
				float3 temp_cast_11 = (_NoiseScaleValue).xxx;
				float3 WorldPosition3905_g56248 = vertexToFrag3890_g56248;
				float temp_output_7_0_g56468 = _NoiseMinValue;
				half Noise_Mask3162_g56248 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_11 * WorldPosition3905_g56248 * 0.1 ), 0.0) ).r - temp_output_7_0_g56468 ) / ( _NoiseMaxValue - temp_output_7_0_g56468 ) ) );
				float4 lerpResult2800_g56248 = lerp( _NoiseColorTwo , _NoiseColorOne , Noise_Mask3162_g56248);
				half3 Noise_Tint2802_g56248 = (lerpResult2800_g56248).rgb;
				float3 vertexToFrag11_g56475 = Noise_Tint2802_g56248;
				...
				float3 Position58_g56495 = WorldPosition3905_g56248;
				...
				half Global_ColorsTex_A1701_g56248 = (lerpResult88_g56495).a;
				float vertexToFrag11_g56486 = Global_ColorsTex_A1701_g56248;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = vertexToFrag11_g56486;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag3890_g56248;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g56248;
						...
						)
			{
				...
				half Leaves_Mask4511_g56248 = 1.0;
				float3 lerpResult4521_g56248 = lerp( float3( 1,1,1 ) , ( vertexToFrag11_g56476 * vertexToFrag11_g56475 * float3(1,1,1) ) , Leaves_Mask4511_g56248);
				float3 lerpResult4519_g56248 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g56248);
				float2 vertexToFrag11_g56515 = packedInput.ase_texcoord7.xy;
				half2 Main_UVs15_g56248 = vertexToFrag11_g56515;
				float4 tex2DNode29_g56248 = tex2D( _MainAlbedoTex, Main_UVs15_g56248 );
				half3 Main_Albedo99_g56248 = ( lerpResult4519_g56248 * (tex2DNode29_g56248).rgb );
				half3 Blend_Albedo265_g56248 = Main_Albedo99_g56248;
				half3 Blend_AlbedoTinted2808_g56248 = ( lerpResult4521_g56248 * Blend_Albedo265_g56248 );
				float dotResult3616_g56248 = dot( Blend_AlbedoTinted2808_g56248 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g56248).xxx;
				float vertexToFrag11_g56486 = packedInput.ase_texcoord5.w;
				half Global_Colors_Influence3668_g56248 = vertexToFrag11_g56486;
				float3 lerpResult3618_g56248 = lerp( Blend_AlbedoTinted2808_g56248 , temp_cast_0 , Global_Colors_Influence3668_g56248);
				float3 vertexToFrag3890_g56248 = packedInput.ase_texcoord8.xyz;
				float3 WorldPosition3905_g56248 = vertexToFrag3890_g56248;
				float3 Position58_g56495 = WorldPosition3905_g56248;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				...
				half3 Global_ColorsTex_RGB1700_g56248 = (lerpResult88_g56495).rgb;
				half3 Global_Colors1954_g56248 = ( Global_ColorsTex_RGB1700_g56248 * 4.594794 );
				half Global_Colors_Value3650_g56248 = _GlobalColors;
				float4 tex2DNode35_g56248 = tex2D( _MainMaskTex, Main_UVs15_g56248 );
				half Main_Mask57_g56248 = tex2DNode35_g56248.b;
				float temp_output_7_0_g56483 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g56248 = saturate( ( ( Main_Mask57_g56248 - temp_output_7_0_g56483 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g56483 ) ) );
				float3 lerpResult3628_g56248 = lerp( Blend_AlbedoTinted2808_g56248 , ( lerpResult3618_g56248 * Global_Colors1954_g56248 ) , ( Global_Colors_Value3650_g56248 * Global_Colors_Mask3692_g56248 ));
				half3 Blend_AlbedoColored863_g56248 = lerpResult3628_g56248;
				float3 temp_output_799_0_g56248 = (_SubsurfaceColor).rgb;
				float dotResult3930_g56248 = dot( temp_output_799_0_g56248 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult3930_g56248).xxx;
				float3 lerpResult3932_g56248 = lerp( temp_output_799_0_g56248 , temp_cast_3 , Global_Colors_Influence3668_g56248);
				float3 lerpResult3942_g56248 = lerp( temp_output_799_0_g56248 , ( lerpResult3932_g56248 * Global_Colors1954_g56248 ) , ( Global_Colors_Value3650_g56248 * Global_Colors_Mask3692_g56248 ));
				half3 Subsurface_Color1722_g56248 = lerpResult3942_g56248;
				half MainLight_Subsurface4041_g56248 = TVE_MainLightParams.a;
				half Subsurface_Intensity1752_g56248 = ( _SubsurfaceValue * MainLight_Subsurface4041_g56248 );
				float temp_output_7_0_g56516 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask1557_g56248 = saturate( ( ( Main_Mask57_g56248 - temp_output_7_0_g56516 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g56516 ) ) );
				half3 Subsurface_Transmission884_g56248 = ( Subsurface_Color1722_g56248 * Subsurface_Intensity1752_g56248 * Subsurface_Mask1557_g56248 );
				half3 MainLight_Direction3926_g56248 = TVE_MainLightDirection;
				float3 normalizeResult2169_g56248 = normalize( V );
				float3 ViewDir_Normalized3963_g56248 = normalizeResult2169_g56248;
				float dotResult785_g56248 = dot( -MainLight_Direction3926_g56248 , ViewDir_Normalized3963_g56248 );
				float saferPower1624_g56248 = max( (dotResult785_g56248*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g56248 = 0.0;
				#else
				float staticSwitch1602_g56248 = ( pow( saferPower1624_g56248 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View782_g56248 = staticSwitch1602_g56248;
				half3 Subsurface_Scattering1693_g56248 = ( Subsurface_Transmission884_g56248 * Blend_AlbedoColored863_g56248 * Mask_Subsurface_View782_g56248 );
				half3 Blend_AlbedoAndSubsurface149_g56248 = ( Blend_AlbedoColored863_g56248 + Subsurface_Scattering1693_g56248 );
				half3 Global_OverlayColor1758_g56248 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3526_g56248 = tex2DNode29_g56248.g;
				float3 Position82_g56460 = WorldPosition3905_g56248;
				...
				half Global_Extras_Overlay156_g56248 = break89_g56460.b;
				float temp_output_1025_0_g56248 = ( _GlobalOverlay * Global_Extras_Overlay156_g56248 );
				half Overlay_Commons1365_g56248 = temp_output_1025_0_g56248;
				float temp_output_7_0_g56499 = _OverlayMaskMinValue;
				half Overlay_Mask269_g56248 = saturate( ( ( ( ( 0.5 + Main_AlbedoTex_G3526_g56248 ) * Overlay_Commons1365_g56248 ) - temp_output_7_0_g56499 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g56499 ) ) );
				float3 lerpResult336_g56248 = lerp( Blend_AlbedoAndSubsurface149_g56248 , Global_OverlayColor1758_g56248 , Overlay_Mask269_g56248);
				half3 Final_Albedo359_g56248 = lerpResult336_g56248;
				
				float3 unpack4112_g56248 = UnpackNormalScale( tex2D( _MainNormalTex, Main_UVs15_g56248 ), _MainNormalValue );
				unpack4112_g56248.z = lerp( 1, unpack4112_g56248.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g56248 = unpack4112_g56248;
				float3 temp_output_13_0_g56506 = Main_Normal137_g56248;
				float3 switchResult12_g56506 = (((isFrontFace>0)?(temp_output_13_0_g56506):(( temp_output_13_0_g56506 * _render_normals_options ))));
				half3 Blend_Normal312_g56248 = switchResult12_g56506;
				half3 Final_Normal366_g56248 = Blend_Normal312_g56248;
				
				float3 hdEmission4189_g56248 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g56467 = packedInput.ase_texcoord7.zw;
				half2 Emissive_UVs2468_g56248 = vertexToFrag11_g56467;
				half Global_Extras_Emissive4203_g56248 = break89_g56460.r;
				float lerpResult4206_g56248 = lerp( 1.0 , Global_Extras_Emissive4203_g56248 , _GlobalEmissive);
				half3 Final_Emissive2476_g56248 = ( (( hdEmission4189_g56248 * tex2D( _EmissiveTex, Emissive_UVs2468_g56248 ) )).rgb * lerpResult4206_g56248 );
				
				half Main_Smoothness227_g56248 = ( tex2DNode35_g56248.a * _MainSmoothnessValue );
				half Blend_Smoothness314_g56248 = Main_Smoothness227_g56248;
				half Global_OverlaySmoothness311_g56248 = TVE_OverlaySmoothness;
				float lerpResult343_g56248 = lerp( Blend_Smoothness314_g56248 , Global_OverlaySmoothness311_g56248 , Overlay_Mask269_g56248);
				half Final_Smoothness371_g56248 = lerpResult343_g56248;
				half Global_Extras_Wetness305_g56248 = break89_g56460.g;
				float lerpResult3673_g56248 = lerp( 0.0 , Global_Extras_Wetness305_g56248 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g56248 = saturate( ( Final_Smoothness371_g56248 + lerpResult3673_g56248 ) );
				
				float lerpResult240_g56248 = lerp( 1.0 , tex2DNode35_g56248.g , _MainOcclusionValue);
				half Main_Occlusion247_g56248 = lerpResult240_g56248;
				half Blend_Occlusion323_g56248 = Main_Occlusion247_g56248;
				
				float localCustomAlphaClip3735_g56248 = ( 0.0 );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 normalizeResult3971_g56248 = normalize( cross( ddy( ase_worldPos ) , ddx( ase_worldPos ) ) );
				float3 NormalsWS_Derivates3972_g56248 = normalizeResult3971_g56248;
				float dotResult2161_g56248 = dot( ViewDir_Normalized3963_g56248 , NormalsWS_Derivates3972_g56248 );
				float dotResult2212_g56248 = dot( ViewDir_Normalized3963_g56248 , float3(0,1,0) );
				half Mask_HView2656_g56248 = dotResult2212_g56248;
				float lerpResult2221_g56248 = lerp( _FadeHorizontalValue , _FadeVerticalValue , Mask_HView2656_g56248);
				float lerpResult3992_g56248 = lerp( 1.0 , abs( dotResult2161_g56248 ) , lerpResult2221_g56248);
				half Fade_Billboard2175_g56248 = lerpResult3992_g56248;
				half Final_AlphaFade3727_g56248 = ( 1.0 * Fade_Billboard2175_g56248 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g56248;
				float Main_Alpha316_g56248 = ( _MainColor.a * tex2DNode29_g56248.a );
				half AlphaTreshold2132_g56248 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g56248 = ( Main_Alpha316_g56248 - ( AlphaTreshold2132_g56248 - 0.5 ) );
				#else
				float staticSwitch3792_g56248 = Main_Alpha316_g56248;
				#endif
				half Final_Alpha3754_g56248 = staticSwitch3792_g56248;
				float temp_output_661_0_g56248 = ( saturate( ( temp_output_41_0_g56470 + ( temp_output_41_0_g56470 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g56248 ) ).r ) ) ) * Final_Alpha3754_g56248 );
				float Alpha3735_g56248 = temp_output_661_0_g56248;
				float Treshold3735_g56248 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g56248 - Treshold3735_g56248);
				#endif
				}
				half Final_Clip914_g56248 = saturate( Alpha3735_g56248 );
				
				half Subsurface_HD1276_g56248 = ( 1.0 - ( Subsurface_Intensity1752_g56248 * Subsurface_Mask1557_g56248 ) );
				
				surfaceDescription.Albedo = Final_Albedo359_g56248;
				surfaceDescription.Normal = Final_Normal366_g56248;
				...
				surfaceDescription.Emission = Final_Emissive2476_g56248;
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g56248;
				surfaceDescription.Occlusion = Blend_Occlusion323_g56248;
				surfaceDescription.Alpha = Final_Clip914_g56248;
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = Subsurface_HD1276_g56248;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag3890_g56248;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half Global_Colors_Influence3668_g56248 = vertexToFrag11_g56486;
				float3 lerpResult3618_g56248 = lerp( Blend_AlbedoTinted2808_g56248 , temp_cast_0 , Global_Colors_Influence3668_g56248);
				float3 vertexToFrag3890_g56248 = packedInput.ase_texcoord3.xyz;
				float3 WorldPosition3905_g56248 = vertexToFrag3890_g56248;
				float3 Position58_g56495 = WorldPosition3905_g56248;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				float4 lerpResult88_g56495 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g56495).xz ) ),temp_output_82_0_g56495 ) , TVE_ColorsUsage[(int)temp_output_82_0_g56495]);
				...
				float3 normalizeResult2169_g56248 = normalize( ase_worldViewDir );
				float3 ViewDir_Normalized3963_g56248 = normalizeResult2169_g56248;
				float dotResult785_g56248 = dot( -MainLight_Direction3926_g56248 , ViewDir_Normalized3963_g56248 );
				float saferPower1624_g56248 = max( (dotResult785_g56248*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord1.xyz = vertexToFrag3890_g56248;
				float2 vertexToFrag11_g56515 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord2.xy = vertexToFrag11_g56515;
					...
					)
			{
				...
				half Final_AlphaFade3727_g56248 = ( 1.0 * Fade_Billboard2175_g56248 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g56248;
				float3 vertexToFrag3890_g56248 = packedInput.ase_texcoord1.xyz;
				float3 WorldPosition3905_g56248 = vertexToFrag3890_g56248;
				float2 vertexToFrag11_g56515 = packedInput.ase_texcoord2.xy;
				half2 Main_UVs15_g56248 = vertexToFrag11_g56515;
				float4 tex2DNode29_g56248 = tex2D( _MainAlbedoTex, Main_UVs15_g56248 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g56248;
					...
					)
			{
				...
				float4 tex2DNode29_g56248 = tex2D( _MainAlbedoTex, Main_UVs15_g56248 );
				half Main_AlbedoTex_G3526_g56248 = tex2DNode29_g56248.g;
				float3 vertexToFrag3890_g56248 = packedInput.ase_texcoord4.xyz;
				float3 WorldPosition3905_g56248 = vertexToFrag3890_g56248;
				float3 Position82_g56460 = WorldPosition3905_g56248;
				float temp_output_84_0_g56460 = _LayerExtrasValue;
				float4 lerpResult88_g56460 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g56460).xz ) ),temp_output_84_0_g56460 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g56460]);
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag3890_g56248;
						...
						)
			{
				...
				half Global_Colors_Influence3668_g56248 = vertexToFrag11_g56486;
				float3 lerpResult3618_g56248 = lerp( Blend_AlbedoTinted2808_g56248 , temp_cast_0 , Global_Colors_Influence3668_g56248);
				float3 vertexToFrag3890_g56248 = packedInput.ase_texcoord10.xyz;
				float3 WorldPosition3905_g56248 = vertexToFrag3890_g56248;
				float3 Position58_g56495 = WorldPosition3905_g56248;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				float4 lerpResult88_g56495 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g56495).xz ) ),temp_output_82_0_g56495 ) , TVE_ColorsUsage[(int)temp_output_82_0_g56495]);
...
/*ASEBEGIN
Version=18912
1920;0;1920;1029;2760.799;722.5121;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;354;-2176,384;Inherit;False;Define Shader Vegetation;-1;;56521;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;406;-1536,-896;Inherit;False;Compile Core;-1;;56520;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;370;-2176,-384;Inherit;False;Base Shader;0;;56248;856f7164d1c579d43a5cf4968a75ca43;81,3880,1,3882,1,3957,1,4029,1,4028,1,3900,1,4204,1,3904,1,3903,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,4499,1,1708,1,3658,1,3509,1,1712,2,3873,0,1718,1,1714,1,1715,1,1717,1,916,0,1762,0,1763,0,3568,0,1949,1,1776,0,3475,1,4210,1,893,0,1745,1,3479,0,4510,0,3501,1,3221,2,1646,1,1757,0,1271,0,3889,1,2807,1,3886,0,2953,1,3887,0,3243,0,3888,0,3728,0,3949,0,2172,0,3883,1,2658,0,1742,0,3484,0,1734,0,1737,0,1735,0,1733,0,1736,0,3575,0,878,0,1550,0,4072,0,4067,0,4070,0,4069,0,4068,0,860,1,2260,1,2261,1,2054,0,2032,0,2039,0,2062,0,4177,1,4217,1,3592,1,2750,0,4242,0;0;20;FLOAT;4528;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4135;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4127;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534
...
Node;AmplifyShaderEditor.FunctionNode;404;-1856,384;Inherit;False;Define Pipeline HD;-1;;56247;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.RangedFloatNode;371;-1984,-896;Half;False;Property;_IsSubsurfaceShader;_IsSubsurfaceShader;202;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;374;-1408,-768;Half;False;Property;_subsurface_shadow;_subsurface_shadow;201;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;405;-1344,-896;Inherit;False;Compile All Shaders;-1;;56246;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6EBE924D88BE468C218147C2EFB5E08CF21672E8
