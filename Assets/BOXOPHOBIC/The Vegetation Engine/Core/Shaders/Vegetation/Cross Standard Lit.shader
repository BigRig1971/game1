	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 Vertex_Motion_Object833_g54503 = ( VertexPosRotationAxis50_g56511 + ( VertexPosOtherAxis82_g56511 * cos( Angle44_g56511 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g56511 ) * sin( Angle44_g56511 ) ) );
				...
				float3 Vertex_Motion_World1118_g54503 = ( temp_output_3474_0_g54503 + appendResult2043_g54503 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				half Noise_Mask3162_g54503 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_11 * WorldPosition3905_g54503 * 0.1 ), 0.0) ).r - temp_output_7_0_g56468 ) / ( _NoiseMaxValue - temp_output_7_0_g56468 ) ) );
				...
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag3890_g54503;
						...
						)
			{
				...
				float3 lerpResult4521_g54503 = lerp( float3( 1,1,1 ) , ( vertexToFrag11_g56476 * vertexToFrag11_g56475 * float3(1,1,1) ) , Leaves_Mask4511_g54503);
				...
				float3 vertexToFrag3890_g54503 = packedInput.ase_texcoord8.xyz;
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
				float3 Position58_g56495 = WorldPosition3905_g54503;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				...
				half Global_Colors_Value3650_g54503 = _GlobalColors;
				...
				half Global_Colors_Mask3692_g54503 = saturate( ( ( Main_Mask57_g54503 - temp_output_7_0_g56483 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g56483 ) ) );
				...
				half Subsurface_Mask1557_g54503 = saturate( ( ( Main_Mask57_g54503 - temp_output_7_0_g56516 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g56516 ) ) );
				...
				half Overlay_Mask269_g54503 = saturate( ( ( ( ( 0.5 + Main_AlbedoTex_G3526_g54503 ) * Overlay_Commons1365_g54503 ) - temp_output_7_0_g56499 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g56499 ) ) );
				...
				float3 normalizeResult3971_g54503 = normalize( cross( ddy( ase_worldPos ) , ddx( ase_worldPos ) ) );
				float3 NormalsWS_Derivates3972_g54503 = normalizeResult3971_g54503;
				float dotResult2161_g54503 = dot( ViewDir_Normalized3963_g54503 , NormalsWS_Derivates3972_g54503 );
				float dotResult2212_g54503 = dot( ViewDir_Normalized3963_g54503 , float3(0,1,0) );
				half Mask_HView2656_g54503 = dotResult2212_g54503;
				float lerpResult2221_g54503 = lerp( _FadeHorizontalValue , _FadeVerticalValue , Mask_HView2656_g54503);
				float lerpResult3992_g54503 = lerp( 1.0 , abs( dotResult2161_g54503 ) , lerpResult2221_g54503);
				half Fade_Billboard2175_g54503 = lerpResult3992_g54503;
				half Final_AlphaFade3727_g54503 = ( 1.0 * Fade_Billboard2175_g54503 );
				...
				surfaceDescription.Albedo = Final_Albedo359_g54503;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag3890_g54503;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half Global_Colors_Influence3668_g54503 = vertexToFrag11_g56486;
				float3 lerpResult3618_g54503 = lerp( Blend_AlbedoTinted2808_g54503 , temp_cast_0 , Global_Colors_Influence3668_g54503);
				float3 vertexToFrag3890_g54503 = packedInput.ase_texcoord3.xyz;
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
				float3 Position58_g56495 = WorldPosition3905_g54503;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				float4 lerpResult88_g56495 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g56495).xz ) ),temp_output_82_0_g56495 ) , TVE_ColorsUsage[(int)temp_output_82_0_g56495]);
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord1.xyz = vertexToFrag3890_g54503;
				float2 vertexToFrag11_g56515 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord2.xy = vertexToFrag11_g56515;
					...
					)
			{
				...
				half Final_AlphaFade3727_g54503 = ( 1.0 * Fade_Billboard2175_g54503 );
				float temp_output_41_0_g56470 = Final_AlphaFade3727_g54503;
				float3 vertexToFrag3890_g54503 = packedInput.ase_texcoord1.xyz;
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
				float2 vertexToFrag11_g56515 = packedInput.ase_texcoord2.xy;
				half2 Main_UVs15_g54503 = vertexToFrag11_g56515;
				float4 tex2DNode29_g54503 = tex2D( _MainAlbedoTex, Main_UVs15_g54503 );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag3890_g54503;
						...
						)
			{
				...
				half Global_Colors_Influence3668_g54503 = vertexToFrag11_g56486;
				float3 lerpResult3618_g54503 = lerp( Blend_AlbedoTinted2808_g54503 , temp_cast_0 , Global_Colors_Influence3668_g54503);
				float3 vertexToFrag3890_g54503 = packedInput.ase_texcoord10.xyz;
				float3 WorldPosition3905_g54503 = vertexToFrag3890_g54503;
				float3 Position58_g56495 = WorldPosition3905_g54503;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				float4 lerpResult88_g56495 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g56495).xz ) ),temp_output_82_0_g56495 ) , TVE_ColorsUsage[(int)temp_output_82_0_g56495]);
...
/*ASEBEGIN
Version=18912
1920;0;1920;1029;2789.946;254.4545;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;129;-1984,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;201;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;322;-1536,-896;Inherit;False;Compile Core;-1;;54501;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;321;-1344,-896;Inherit;False;Compile All Shaders;-1;;54502;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;320;-1856,384;Inherit;False;Define Pipeline HD;-1;;56521;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
...
ASEEND*/
//CHKSM=C563D6263B4806937C5249C16514FD5EB6D662D7
