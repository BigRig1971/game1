	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 VertexPosition3588_g56229 = inputMesh.positionOS;
				float3 appendResult60_g56480 = (float3(inputMesh.ase_texcoord.z , 0.0 , inputMesh.ase_texcoord.w));
				half3 Mesh_PivotsData2831_g56229 = ( appendResult60_g56480 * _VertexPivotMode );
				half3 Mesh_PivotsOS2291_g56229 = Mesh_PivotsData2831_g56229;
				float3 temp_output_2283_0_g56229 = ( VertexPosition3588_g56229 - Mesh_PivotsOS2291_g56229 );
				half3 VertexPos40_g56507 = temp_output_2283_0_g56229;
				...
				float Bounds_Height374_g56229 = _MaxBoundsInfo.y;
				half WorldData19_g56472 = ( Bounds_Height374_g56229 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g56472 = WorldData19_g56472;
				#else
				float staticSwitch14_g56472 = ObjectData20_g56472;
				#endif
				float Motion_Max_Bending1133_g56229 = staticSwitch14_g56472;
				...
				float3 vertexToFrag4224_g56229 = temp_output_114_0_g56488;
				half3 ObjectData20_g56464 = vertexToFrag4224_g56229;
				float3 vertexToFrag3890_g56229 = ase_worldPos;
				half3 WorldData19_g56464 = vertexToFrag3890_g56229;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g56464 = WorldData19_g56464;
				#else
				float3 staticSwitch14_g56464 = ObjectData20_g56464;
				#endif
				float3 ObjectPosition4223_g56229 = staticSwitch14_g56464;
				float3 Position83_g56474 = ObjectPosition4223_g56229;
				...
				half4 Global_Motion_Params3909_g56229 = lerpResult87_g56474;
				float4 break322_g56517 = Global_Motion_Params3909_g56229;
				...
				half Wind_Power_103106_g56229 = lerpResult376_g56517;
				float2 panner73_g56487 = ( _TimeParameters.x * (TVE_NoiseParams).xy + ( (ObjectPosition4223_g56229).xz * TVE_NoiseParams.z ));
				...
				half Wind_Power2223_g56229 = Wind_Power369_g56517;
				float temp_output_167_0_g56487 = Wind_Power2223_g56229;
				...
				half Global_NoiseTex_R34_g56229 = break174_g56487.r;
				...
				half2 Wind_DirectionOS39_g56229 = (temp_output_339_0_g56517).xz;
				half Input_Speed62_g56504 = _MotionSpeed_10;
				float mulTime373_g56504 = _TimeParameters.x * Input_Speed62_g56504;
				float3 break111_g56453 = ObjectPosition4223_g56229;
				...
				#endif
				half Motion_Variation3073_g56229 = staticSwitch14_g56454;
				half Motion_Variation284_g56504 = ( _MotionVariation_10 * Motion_Variation3073_g56229 );
				...
				half Wind_Squash4479_g56229 = break322_g56517.w;
				half Input_WindSquash419_g56504 = Wind_Squash4479_g56229;
				half Input_WindPower327_g56504 = Wind_Power_103106_g56229;
				...
				half Mesh_Motion_1082_g56229 = inputMesh.ase_texcoord3.x;
				half2 Motion_10_Bending2258_g56229 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g56229 ) * Wind_Power_103106_g56229 * Global_NoiseTex_R34_g56229 * Wind_DirectionOS39_g56229 * lerpResult321_g56504 * Mesh_Motion_1082_g56229 );
				half Interaction_Amplitude4137_g56229 = _InteractionAmplitude;
				float3 Position83_g56496 = ObjectPosition4223_g56229;
				...
				half4 Global_React_Params4173_g56229 = lerpResult87_g56496;
				float4 break322_g56492 = Global_React_Params4173_g56229;
				half Interaction_Mask66_g56229 = break322_g56492.z;
				...
				half2 Interaction_DirectionOS4158_g56229 = (temp_output_339_0_g56492).xz;
				float lerpResult4494_g56229 = lerp( 1.0 , Mesh_Motion_1082_g56229 , _InteractionMaskValue);
				half2 Motion_10_Interaction53_g56229 = ( Interaction_Amplitude4137_g56229 * Motion_Max_Bending1133_g56229 * Interaction_Mask66_g56229 * Interaction_Mask66_g56229 * Interaction_DirectionOS4158_g56229 * lerpResult4494_g56229 );
				float2 lerpResult109_g56229 = lerp( Motion_10_Bending2258_g56229 , Motion_10_Interaction53_g56229 , ( Interaction_Mask66_g56229 * saturate( Interaction_Amplitude4137_g56229 ) ));
				float2 break143_g56229 = lerpResult109_g56229;
				half Motion_10_ZAxis190_g56229 = break143_g56229.y;
				half Angle44_g56507 = Motion_10_ZAxis190_g56229;
				...
				half Motion_10_XAxis216_g56229 = break143_g56229.x;
				half Angle44_g56511 = -Motion_10_XAxis216_g56229;
				...
				float Motion_Variation330_g56455 = ( _MotionVariation_32 * Motion_Variation3073_g56229 );
				float Bounds_Radius121_g56229 = _MaxBoundsInfo.x;
				half Input_Amplitude58_g56455 = ( _MotionAmplitude_32 * Bounds_Radius121_g56229 * 0.1 );
				...
				half Mesh_Motion_30144_g56229 = inputMesh.ase_texcoord3.z;
				float lerpResult378_g56517 = lerp( TVE_MotionParamsMin.z , TVE_MotionParamsMax.z , Wind_Power369_g56517);
				half Wind_Power_303115_g56229 = lerpResult378_g56517;
				float temp_output_7_0_g56479 = TVE_MotionFadeEnd;
				half Wind_FadeOut4005_g56229 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g56479 ) / ( TVE_MotionFadeStart - temp_output_7_0_g56479 ) ) );
				half Motion_Selective4260_g56229 = 1.0;
				half3 Motion_30_Details263_g56229 = ( temp_output_299_0_g56455 * ( Global_NoiseTex_R34_g56229 * Mesh_Motion_30144_g56229 * Wind_Power_303115_g56229 * Wind_FadeOut4005_g56229 * Motion_Selective4260_g56229 ) );
				float3 Vertex_Motion_Object833_g56229 = ( ( VertexPosRotationAxis50_g56511 + ( VertexPosOtherAxis82_g56511 * cos( Angle44_g56511 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g56511 ) * sin( Angle44_g56511 ) ) ) + Motion_30_Details263_g56229 );
				float3 temp_output_3474_0_g56229 = ( VertexPosition3588_g56229 - Mesh_PivotsOS2291_g56229 );
				float3 appendResult2043_g56229 = (float3(Motion_10_XAxis216_g56229 , 0.0 , Motion_10_ZAxis190_g56229));
				float3 Vertex_Motion_World1118_g56229 = ( ( temp_output_3474_0_g56229 + appendResult2043_g56229 ) + Motion_30_Details263_g56229 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch3312_g56229 = Vertex_Motion_World1118_g56229;
				#else
				float3 staticSwitch3312_g56229 = ( Vertex_Motion_Object833_g56229 + ( 0.0 * _VertexDataMode ) );
				#endif
				half Global_Vertex_Size174_g56229 = break322_g56492.w;
				float lerpResult346_g56229 = lerp( 1.0 , Global_Vertex_Size174_g56229 , _GlobalSize);
				float3 appendResult3480_g56229 = (float3(lerpResult346_g56229 , lerpResult346_g56229 , lerpResult346_g56229));
				half3 ObjectData20_g56469 = appendResult3480_g56229;
				...
				#endif
				half3 Vertex_Size1741_g56229 = staticSwitch14_g56469;
				half3 _Vector5 = half3(1,1,1);
				float temp_output_7_0_g56461 = _SizeFadeEndValue;
				float temp_output_335_0_g56229 = saturate( ( ( ( distance( _WorldSpaceCameraPos , ObjectPosition4223_g56229 ) * ( 1.0 / TVE_DistanceFadeBias ) ) - temp_output_7_0_g56461 ) / ( _SizeFadeStartValue - temp_output_7_0_g56461 ) ) );
				float3 appendResult3482_g56229 = (float3(temp_output_335_0_g56229 , temp_output_335_0_g56229 , temp_output_335_0_g56229));
				float3 lerpResult3556_g56229 = lerp( _Vector5 , appendResult3482_g56229 , _SizeFadeMode);
				half3 ObjectData20_g56477 = lerpResult3556_g56229;
				...
				#endif
				float3 Vertex_SizeFade1740_g56229 = staticSwitch14_g56477;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult2696_g56229 = normalize( ase_worldViewDir );
				float3 break2709_g56229 = cross( normalizeResult2696_g56229 , half3(0,1,0) );
				float3 appendResult2710_g56229 = (float3(-break2709_g56229.z , 0.0 , break2709_g56229.x));
				float3 appendResult2667_g56229 = (float3(inputMesh.ase_color.r , 0.5 , inputMesh.ase_color.r));
				float3 normalizeResult2169_g56229 = normalize( ase_worldViewDir );
				float3 ViewDir_Normalized3963_g56229 = normalizeResult2169_g56229;
				float dotResult2212_g56229 = dot( ViewDir_Normalized3963_g56229 , float3(0,1,0) );
				half Mask_HView2656_g56229 = dotResult2212_g56229;
				float saferPower2652_g56229 = max( Mask_HView2656_g56229 , 0.0001 );
				half3 Grass_Coverage2661_g56229 = ( ( ( mul( GetWorldToObjectMatrix(), float4( appendResult2710_g56229 , 0.0 ) ).xyz * _PerspectivePushValue ) + ( (appendResult2667_g56229*2.0 + -1.0) * _PerspectiveNoiseValue ) ) * inputMesh.ase_color.a * pow( saferPower2652_g56229 , _PerspectiveAngleValue ) );
				float3 Final_VertexPosition890_g56229 = ( ( ( staticSwitch3312_g56229 * Vertex_Size1741_g56229 * Vertex_SizeFade1740_g56229 ) + Mesh_PivotsOS2291_g56229 + Grass_Coverage2661_g56229 ) + _DisableSRPBatcher );
				
				float temp_output_7_0_g56494 = _GradientMinValue;
				float4 lerpResult2779_g56229 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( inputMesh.ase_color.a - temp_output_7_0_g56494 ) / ( _GradientMaxValue - temp_output_7_0_g56494 ) ) ));
				half3 Gradient_Tint2784_g56229 = (lerpResult2779_g56229).rgb;
				float3 vertexToFrag11_g56476 = Gradient_Tint2784_g56229;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag11_g56476;
				float3 temp_cast_15 = (_NoiseScaleValue).xxx;
				float3 WorldPosition3905_g56229 = vertexToFrag3890_g56229;
				float temp_output_7_0_g56468 = _NoiseMinValue;
				half Noise_Mask3162_g56229 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_15 * WorldPosition3905_g56229 * 0.1 ), 0.0) ).r - temp_output_7_0_g56468 ) / ( _NoiseMaxValue - temp_output_7_0_g56468 ) ) );
				float4 lerpResult2800_g56229 = lerp( _NoiseColorTwo , _NoiseColorOne , Noise_Mask3162_g56229);
				half3 Noise_Tint2802_g56229 = (lerpResult2800_g56229).rgb;
				float3 vertexToFrag11_g56475 = Noise_Tint2802_g56229;
				...
				half Global_NoiseTex_H2869_g56229 = pow( abs( tex2DNode75_g56487.a ) , lerpResult169_g56487 );
				half3 Highlight_Tint3231_g56229 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g56229 * Wind_Power_103106_g56229 * Wind_FadeOut4005_g56229 * inputMesh.ase_color.a ) + float3( 1,1,1 ) );
				float3 vertexToFrag11_g56473 = Highlight_Tint3231_g56229;
				...
				float3 Position58_g56495 = WorldPosition3905_g56229;
				...
				half Global_ColorsTex_A1701_g56229 = (lerpResult88_g56495).a;
				float vertexToFrag11_g56486 = Global_ColorsTex_A1701_g56229;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = vertexToFrag11_g56486;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag3890_g56229;
				float3 temp_cast_18 = (1.0).xxx;
				float Mesh_Occlusion318_g56229 = inputMesh.ase_color.g;
				float temp_output_7_0_g56463 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g56229 = lerp( (_VertexOcclusionColor).rgb , temp_cast_18 , saturate( ( ( Mesh_Occlusion318_g56229 - temp_output_7_0_g56463 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g56463 ) ) ));
				float3 vertexToFrag11_g56482 = lerpResult2945_g56229;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g56229;
						...
						)
			{
				...
				half Leaves_Mask4511_g56229 = 1.0;
				float3 lerpResult4521_g56229 = lerp( float3( 1,1,1 ) , ( vertexToFrag11_g56476 * vertexToFrag11_g56475 * vertexToFrag11_g56473 ) , Leaves_Mask4511_g56229);
				float3 lerpResult4519_g56229 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g56229);
				float2 vertexToFrag11_g56515 = packedInput.ase_texcoord8.xy;
				half2 Main_UVs15_g56229 = vertexToFrag11_g56515;
				float4 tex2DNode29_g56229 = tex2D( _MainAlbedoTex, Main_UVs15_g56229 );
				half3 Main_Albedo99_g56229 = ( lerpResult4519_g56229 * (tex2DNode29_g56229).rgb );
				half3 Blend_Albedo265_g56229 = Main_Albedo99_g56229;
				half3 Blend_AlbedoTinted2808_g56229 = ( lerpResult4521_g56229 * Blend_Albedo265_g56229 );
				float dotResult3616_g56229 = dot( Blend_AlbedoTinted2808_g56229 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g56229).xxx;
				float vertexToFrag11_g56486 = packedInput.ase_texcoord5.w;
				half Global_Colors_Influence3668_g56229 = vertexToFrag11_g56486;
				float3 lerpResult3618_g56229 = lerp( Blend_AlbedoTinted2808_g56229 , temp_cast_0 , Global_Colors_Influence3668_g56229);
				float3 vertexToFrag3890_g56229 = packedInput.ase_texcoord9.xyz;
				float3 WorldPosition3905_g56229 = vertexToFrag3890_g56229;
				float3 Position58_g56495 = WorldPosition3905_g56229;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				...
				half3 Global_ColorsTex_RGB1700_g56229 = (lerpResult88_g56495).rgb;
				half3 Global_Colors1954_g56229 = ( Global_ColorsTex_RGB1700_g56229 * 4.594794 );
				float lerpResult3870_g56229 = lerp( 1.0 , packedInput.ase_color.r , _ColorsVariationValue);
				half Global_Colors_Value3650_g56229 = ( _GlobalColors * lerpResult3870_g56229 );
				float temp_output_7_0_g56483 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g56229 = saturate( ( ( ( 1.0 - packedInput.ase_color.a ) - temp_output_7_0_g56483 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g56483 ) ) );
				float3 lerpResult3628_g56229 = lerp( Blend_AlbedoTinted2808_g56229 , ( lerpResult3618_g56229 * Global_Colors1954_g56229 ) , ( Global_Colors_Value3650_g56229 * Global_Colors_Mask3692_g56229 ));
				half3 Blend_AlbedoColored863_g56229 = lerpResult3628_g56229;
				float3 temp_output_799_0_g56229 = (_SubsurfaceColor).rgb;
				float dotResult3930_g56229 = dot( temp_output_799_0_g56229 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult3930_g56229).xxx;
				float3 lerpResult3932_g56229 = lerp( temp_output_799_0_g56229 , temp_cast_3 , Global_Colors_Influence3668_g56229);
				float3 lerpResult3942_g56229 = lerp( temp_output_799_0_g56229 , ( lerpResult3932_g56229 * Global_Colors1954_g56229 ) , ( Global_Colors_Value3650_g56229 * Global_Colors_Mask3692_g56229 ));
				half3 Subsurface_Color1722_g56229 = lerpResult3942_g56229;
				half MainLight_Subsurface4041_g56229 = TVE_MainLightParams.a;
				half Subsurface_Intensity1752_g56229 = ( _SubsurfaceValue * MainLight_Subsurface4041_g56229 );
				float temp_output_7_0_g56516 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask1557_g56229 = saturate( ( ( packedInput.ase_color.a - temp_output_7_0_g56516 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g56516 ) ) );
				half3 Subsurface_Transmission884_g56229 = ( Subsurface_Color1722_g56229 * Subsurface_Intensity1752_g56229 * Subsurface_Mask1557_g56229 );
				half3 MainLight_Direction3926_g56229 = TVE_MainLightDirection;
				float3 normalizeResult2169_g56229 = normalize( V );
				float3 ViewDir_Normalized3963_g56229 = normalizeResult2169_g56229;
				float dotResult785_g56229 = dot( -MainLight_Direction3926_g56229 , ViewDir_Normalized3963_g56229 );
				float saferPower1624_g56229 = max( (dotResult785_g56229*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g56229 = 0.0;
				#else
				float staticSwitch1602_g56229 = ( pow( saferPower1624_g56229 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View782_g56229 = staticSwitch1602_g56229;
				half3 Subsurface_Scattering1693_g56229 = ( Subsurface_Transmission884_g56229 * Blend_AlbedoColored863_g56229 * Mask_Subsurface_View782_g56229 );
				half3 Blend_AlbedoAndSubsurface149_g56229 = ( Blend_AlbedoColored863_g56229 + Subsurface_Scattering1693_g56229 );
				half3 Global_OverlayColor1758_g56229 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3526_g56229 = tex2DNode29_g56229.g;
				float3 Position82_g56460 = WorldPosition3905_g56229;
				...
				half Global_Extras_Overlay156_g56229 = break89_g56460.b;
				float temp_output_1025_0_g56229 = ( _GlobalOverlay * Global_Extras_Overlay156_g56229 );
				float lerpResult1065_g56229 = lerp( 1.0 , packedInput.ase_color.r , _OverlayVariationValue);
				half Overlay_Commons1365_g56229 = ( temp_output_1025_0_g56229 * lerpResult1065_g56229 );
				float temp_output_7_0_g56499 = _OverlayMaskMinValue;
				half Overlay_Mask269_g56229 = saturate( ( ( ( ( ( packedInput.ase_color.a * 0.5 ) + Main_AlbedoTex_G3526_g56229 ) * Overlay_Commons1365_g56229 ) - temp_output_7_0_g56499 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g56499 ) ) );
				float3 lerpResult336_g56229 = lerp( Blend_AlbedoAndSubsurface149_g56229 , Global_OverlayColor1758_g56229 , Overlay_Mask269_g56229);
				half3 Final_Albedo359_g56229 = lerpResult336_g56229;
				float3 vertexToFrag11_g56482 = packedInput.ase_texcoord10.xyz;
				float3 Vertex_Occlusion648_g56229 = saturate( vertexToFrag11_g56482 );
				
				float3 unpack4112_g56229 = UnpackNormalScale( tex2D( _MainNormalTex, Main_UVs15_g56229 ), _MainNormalValue );
				unpack4112_g56229.z = lerp( 1, unpack4112_g56229.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g56229 = unpack4112_g56229;
				float3 temp_output_13_0_g56506 = Main_Normal137_g56229;
				float3 switchResult12_g56506 = (((isFrontFace>0)?(temp_output_13_0_g56506):(( temp_output_13_0_g56506 * _render_normals_options ))));
				half3 Blend_Normal312_g56229 = switchResult12_g56506;
				half3 Final_Normal366_g56229 = Blend_Normal312_g56229;
				
				float3 hdEmission4189_g56229 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g56467 = packedInput.ase_texcoord8.zw;
				half2 Emissive_UVs2468_g56229 = vertexToFrag11_g56467;
				half Global_Extras_Emissive4203_g56229 = break89_g56460.r;
				float lerpResult4206_g56229 = lerp( 1.0 , Global_Extras_Emissive4203_g56229 , _GlobalEmissive);
				half3 Final_Emissive2476_g56229 = ( (( hdEmission4189_g56229 * tex2D( _EmissiveTex, Emissive_UVs2468_g56229 ) )).rgb * lerpResult4206_g56229 );
				
				float4 tex2DNode35_g56229 = tex2D( _MainMaskTex, Main_UVs15_g56229 );
				half Main_Smoothness227_g56229 = ( tex2DNode35_g56229.a * _MainSmoothnessValue );
				half Blend_Smoothness314_g56229 = Main_Smoothness227_g56229;
				half Global_OverlaySmoothness311_g56229 = TVE_OverlaySmoothness;
				float lerpResult343_g56229 = lerp( Blend_Smoothness314_g56229 , Global_OverlaySmoothness311_g56229 , Overlay_Mask269_g56229);
				half Final_Smoothness371_g56229 = lerpResult343_g56229;
				half Global_Extras_Wetness305_g56229 = break89_g56460.g;
				float lerpResult3673_g56229 = lerp( 0.0 , Global_Extras_Wetness305_g56229 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g56229 = saturate( ( Final_Smoothness371_g56229 + lerpResult3673_g56229 ) );
				
				float lerpResult240_g56229 = lerp( 1.0 , tex2DNode35_g56229.g , _MainOcclusionValue);
				half Main_Occlusion247_g56229 = lerpResult240_g56229;
				half Blend_Occlusion323_g56229 = Main_Occlusion247_g56229;
				
				float localCustomAlphaClip3735_g56229 = ( 0.0 );
				half Final_AlphaFade3727_g56229 = 1.0;
				float Main_Alpha316_g56229 = ( _MainColor.a * tex2DNode29_g56229.a );
				float Mesh_Variation16_g56229 = packedInput.ase_color.r;
				float lerpResult4033_g56229 = lerp( 0.9 , (Mesh_Variation16_g56229*0.5 + 0.5) , _AlphaVariationValue);
				half Global_Extras_Alpha1033_g56229 = break89_g56460.a;
				float temp_output_4022_0_g56229 = ( lerpResult4033_g56229 - ( 1.0 - Global_Extras_Alpha1033_g56229 ) );
				half AlphaTreshold2132_g56229 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch4017_g56229 = ( temp_output_4022_0_g56229 + AlphaTreshold2132_g56229 );
				#else
				float staticSwitch4017_g56229 = temp_output_4022_0_g56229;
				#endif
				float lerpResult4011_g56229 = lerp( 1.0 , staticSwitch4017_g56229 , _GlobalAlpha);
				half Global_Alpha315_g56229 = saturate( lerpResult4011_g56229 );
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g56229 = ( ( Main_Alpha316_g56229 * Global_Alpha315_g56229 ) - ( AlphaTreshold2132_g56229 - 0.5 ) );
				#else
				float staticSwitch3792_g56229 = ( Main_Alpha316_g56229 * Global_Alpha315_g56229 );
				#endif
				half Final_Alpha3754_g56229 = staticSwitch3792_g56229;
				float temp_output_661_0_g56229 = ( Final_AlphaFade3727_g56229 * Final_Alpha3754_g56229 );
				float Alpha3735_g56229 = temp_output_661_0_g56229;
				float Treshold3735_g56229 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g56229 - Treshold3735_g56229);
				#endif
				}
				half Final_Clip914_g56229 = saturate( Alpha3735_g56229 );
				
				half Subsurface_HD1276_g56229 = ( 1.0 - ( Subsurface_Intensity1752_g56229 * Subsurface_Mask1557_g56229 ) );
				
				surfaceDescription.Albedo = ( Final_Albedo359_g56229 * Vertex_Occlusion648_g56229 );
				surfaceDescription.Normal = Final_Normal366_g56229;
				...
				surfaceDescription.Emission = Final_Emissive2476_g56229;
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g56229;
				surfaceDescription.Occlusion = Blend_Occlusion323_g56229;
				surfaceDescription.Alpha = Final_Clip914_g56229;
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = Subsurface_HD1276_g56229;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g56229;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half Global_Colors_Influence3668_g56229 = vertexToFrag11_g56486;
				float3 lerpResult3618_g56229 = lerp( Blend_AlbedoTinted2808_g56229 , temp_cast_0 , Global_Colors_Influence3668_g56229);
				float3 vertexToFrag3890_g56229 = packedInput.ase_texcoord4.xyz;
				float3 WorldPosition3905_g56229 = vertexToFrag3890_g56229;
				float3 Position58_g56495 = WorldPosition3905_g56229;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				float4 lerpResult88_g56495 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g56495).xz ) ),temp_output_82_0_g56495 ) , TVE_ColorsUsage[(int)temp_output_82_0_g56495]);
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag3890_g56229;
					...
					)
			{
				...
				float Mesh_Variation16_g56229 = packedInput.ase_color.r;
				float lerpResult4033_g56229 = lerp( 0.9 , (Mesh_Variation16_g56229*0.5 + 0.5) , _AlphaVariationValue);
				float3 vertexToFrag3890_g56229 = packedInput.ase_texcoord2.xyz;
				float3 WorldPosition3905_g56229 = vertexToFrag3890_g56229;
				float3 Position82_g56460 = WorldPosition3905_g56229;
				float temp_output_84_0_g56460 = _LayerExtrasValue;
				float4 lerpResult88_g56460 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g56460).xz ) ),temp_output_84_0_g56460 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g56460]);
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag3890_g56229;
				float3 temp_cast_18 = (1.0).xxx;
				float Mesh_Occlusion318_g56229 = inputMesh.ase_color.g;
				float temp_output_7_0_g56463 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g56229 = lerp( (_VertexOcclusionColor).rgb , temp_cast_18 , saturate( ( ( Mesh_Occlusion318_g56229 - temp_output_7_0_g56463 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g56463 ) ) ));
						...
						)
			{
				...
				half Global_Colors_Influence3668_g56229 = vertexToFrag11_g56486;
				float3 lerpResult3618_g56229 = lerp( Blend_AlbedoTinted2808_g56229 , temp_cast_0 , Global_Colors_Influence3668_g56229);
				float3 vertexToFrag3890_g56229 = packedInput.ase_texcoord11.xyz;
				float3 WorldPosition3905_g56229 = vertexToFrag3890_g56229;
				float3 Position58_g56495 = WorldPosition3905_g56229;
				float temp_output_82_0_g56495 = _LayerColorsValue;
				float4 lerpResult88_g56495 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g56495).xz ) ),temp_output_82_0_g56495 ) , TVE_ColorsUsage[(int)temp_output_82_0_g56495]);
...
/*ASEBEGIN
Version=18912
1920;0;1920;1029;2850.488;478.552;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1051;-1536,-896;Inherit;False;Compile Core;-1;;56225;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;713;-2176,384;Inherit;False;Define Shader Grass;-1;;56226;921559c53826c0142ba6e27dd03eaef2;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=ED8253111195D52E3CB2C5CC578AE191C2F1E0F4
