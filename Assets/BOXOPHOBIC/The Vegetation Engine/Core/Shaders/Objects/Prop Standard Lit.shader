	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 VertexPosition3588_g56178 = inputMesh.positionOS;
				float3 Final_VertexPosition890_g56178 = ( VertexPosition3588_g56178 + _DisableSRPBatcher );
				...
				float2 lerpResult1545_g56178 = lerp( inputMesh.ase_texcoord.xy , inputMesh.uv1.xy , _DetailCoordMode);
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g56178 = lerpResult1545_g56178;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float2 staticSwitch3466_g56178 = (ase_worldPos).xz;
				#else
				float2 staticSwitch3466_g56178 = lerpResult1545_g56178;
				#endif
				float2 vertexToFrag11_g56505 = ( ( staticSwitch3466_g56178 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord5.zw = vertexToFrag11_g56505;
				half Mesh_DetailMask90_g56178 = inputMesh.ase_color.b;
				float vertexToFrag11_g56471 = ( ( Mesh_DetailMask90_g56178 - 0.5 ) + _DetailMeshValue );
				...
				float3 vertexToFrag3890_g56178 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag3890_g56178;
				
				float2 vertexToFrag11_g56467 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord8.xy = vertexToFrag11_g56467;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g56178;
						...
						)
			{
				...
				half Leaves_Mask4511_g56178 = 1.0;
				float3 lerpResult4521_g56178 = lerp( float3( 1,1,1 ) , ( float3(1,1,1) * float3(1,1,1) * float3(1,1,1) ) , Leaves_Mask4511_g56178);
				float3 lerpResult4519_g56178 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g56178);
				float2 vertexToFrag11_g56515 = packedInput.ase_texcoord5.xy;
				half2 Main_UVs15_g56178 = vertexToFrag11_g56515;
				float4 tex2DNode29_g56178 = tex2D( _MainAlbedoTex, Main_UVs15_g56178 );
				half3 Main_Albedo99_g56178 = ( lerpResult4519_g56178 * (tex2DNode29_g56178).rgb );
				float2 vertexToFrag11_g56505 = packedInput.ase_texcoord5.zw;
				half2 Second_UVs17_g56178 = vertexToFrag11_g56505;
				half3 Second_Albedo153_g56178 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g56178 ) )).rgb;
				float vertexToFrag11_g56471 = packedInput.ase_texcoord6.x;
				float temp_output_3919_0_g56178 = vertexToFrag11_g56471;
				float3 unpack4112_g56178 = UnpackNormalScale( tex2D( _MainNormalTex, Main_UVs15_g56178 ), _MainNormalValue );
				unpack4112_g56178.z = lerp( 1, unpack4112_g56178.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g56178 = unpack4112_g56178;
				...
				float3 tanNormal4099_g56178 = Main_Normal137_g56178;
				float3 worldNormal4099_g56178 = float3(dot(tanToWorld0,tanNormal4099_g56178), dot(tanToWorld1,tanNormal4099_g56178), dot(tanToWorld2,tanNormal4099_g56178));
				float3 Main_Normal_WS4101_g56178 = worldNormal4099_g56178;
				float lerpResult1537_g56178 = lerp( Main_Normal_WS4101_g56178.y , -Main_Normal_WS4101_g56178.y , _DetailProjectionMode);
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float staticSwitch3467_g56178 = temp_output_3919_0_g56178;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float staticSwitch3467_g56178 = ( ( lerpResult1537_g56178 * 0.5 ) + _DetailMeshValue );
				#else
				float staticSwitch3467_g56178 = temp_output_3919_0_g56178;
				#endif
				half Blend_Source1540_g56178 = staticSwitch3467_g56178;
				float4 tex2DNode35_g56178 = tex2D( _MainMaskTex, Main_UVs15_g56178 );
				half Main_Mask57_g56178 = tex2DNode35_g56178.b;
				float4 tex2DNode33_g56178 = tex2D( _SecondMaskTex, Second_UVs17_g56178 );
				half Second_Mask81_g56178 = tex2DNode33_g56178.b;
				float lerpResult1327_g56178 = lerp( Main_Mask57_g56178 , Second_Mask81_g56178 , _DetailMaskMode);
				float lerpResult4058_g56178 = lerp( lerpResult1327_g56178 , ( 1.0 - lerpResult1327_g56178 ) , _DetailMaskInvertMode);
				float temp_output_7_0_g56466 = _DetailBlendMinValue;
				half Mask_Detail147_g56178 = saturate( ( ( saturate( ( Blend_Source1540_g56178 + ( Blend_Source1540_g56178 * lerpResult4058_g56178 ) ) ) - temp_output_7_0_g56466 ) / ( _DetailBlendMaxValue - temp_output_7_0_g56466 ) ) );
				float3 lerpResult235_g56178 = lerp( Main_Albedo99_g56178 , ( Main_Albedo99_g56178 * Second_Albedo153_g56178 * 4.594794 ) , Mask_Detail147_g56178);
				float3 lerpResult208_g56178 = lerp( Main_Albedo99_g56178 , Second_Albedo153_g56178 , Mask_Detail147_g56178);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4062_g56178 = lerpResult235_g56178;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4062_g56178 = lerpResult208_g56178;
				#else
				float3 staticSwitch4062_g56178 = lerpResult235_g56178;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch255_g56178 = Main_Albedo99_g56178;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch255_g56178 = staticSwitch4062_g56178;
				#else
				float3 staticSwitch255_g56178 = Main_Albedo99_g56178;
				#endif
				half3 Blend_Albedo265_g56178 = staticSwitch255_g56178;
				half3 Blend_AlbedoTinted2808_g56178 = ( lerpResult4521_g56178 * Blend_Albedo265_g56178 );
				half3 Blend_AlbedoColored863_g56178 = Blend_AlbedoTinted2808_g56178;
				half3 Blend_AlbedoAndSubsurface149_g56178 = Blend_AlbedoColored863_g56178;
				half3 Global_OverlayColor1758_g56178 = (TVE_OverlayColor).rgb;
				float lerpResult3567_g56178 = lerp( _OverlayBottomValue , 1.0 , Main_Normal_WS4101_g56178.y);
				half Main_AlbedoTex_G3526_g56178 = tex2DNode29_g56178.g;
				half Second_AlbedoTex_G3581_g56178 = (tex2D( _SecondAlbedoTex, Second_UVs17_g56178 )).g;
				float lerpResult3579_g56178 = lerp( Main_AlbedoTex_G3526_g56178 , Second_AlbedoTex_G3581_g56178 , Mask_Detail147_g56178);
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch3574_g56178 = Main_AlbedoTex_G3526_g56178;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch3574_g56178 = lerpResult3579_g56178;
				#else
				float staticSwitch3574_g56178 = Main_AlbedoTex_G3526_g56178;
				#endif
				float3 vertexToFrag3890_g56178 = packedInput.ase_texcoord7.xyz;
				float3 WorldPosition3905_g56178 = vertexToFrag3890_g56178;
				float3 Position82_g56460 = WorldPosition3905_g56178;
				...
				half Global_Extras_Overlay156_g56178 = break89_g56460.b;
				float temp_output_1025_0_g56178 = ( _GlobalOverlay * Global_Extras_Overlay156_g56178 );
				half Overlay_Commons1365_g56178 = temp_output_1025_0_g56178;
				float temp_output_7_0_g56499 = _OverlayMaskMinValue;
				half Overlay_Mask269_g56178 = saturate( ( ( ( ( ( lerpResult3567_g56178 * 0.5 ) + staticSwitch3574_g56178 ) * Overlay_Commons1365_g56178 ) - temp_output_7_0_g56499 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g56499 ) ) );
				float3 lerpResult336_g56178 = lerp( Blend_AlbedoAndSubsurface149_g56178 , Global_OverlayColor1758_g56178 , Overlay_Mask269_g56178);
				half3 Final_Albedo359_g56178 = lerpResult336_g56178;
				
				float3 unpack4114_g56178 = UnpackNormalScale( tex2D( _SecondNormalTex, Second_UVs17_g56178 ), _SecondNormalValue );
				unpack4114_g56178.z = lerp( 1, unpack4114_g56178.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g56178 = unpack4114_g56178;
				float3 lerpResult230_g56178 = lerp( float3( 0,0,1 ) , Second_Normal179_g56178 , Mask_Detail147_g56178);
				float3 lerpResult3372_g56178 = lerp( float3( 0,0,1 ) , Main_Normal137_g56178 , _DetailNormalValue);
				float3 lerpResult3376_g56178 = lerp( Main_Normal137_g56178 , BlendNormal( lerpResult3372_g56178 , Second_Normal179_g56178 ) , Mask_Detail147_g56178);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4063_g56178 = BlendNormal( Main_Normal137_g56178 , lerpResult230_g56178 );
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4063_g56178 = lerpResult3376_g56178;
				#else
				float3 staticSwitch4063_g56178 = BlendNormal( Main_Normal137_g56178 , lerpResult230_g56178 );
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch267_g56178 = Main_Normal137_g56178;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch267_g56178 = staticSwitch4063_g56178;
				#else
				float3 staticSwitch267_g56178 = Main_Normal137_g56178;
				#endif
				float3 temp_output_13_0_g56506 = staticSwitch267_g56178;
				float3 switchResult12_g56506 = (((isFrontFace>0)?(temp_output_13_0_g56506):(( temp_output_13_0_g56506 * _render_normals_options ))));
				half3 Blend_Normal312_g56178 = switchResult12_g56506;
				half3 Final_Normal366_g56178 = Blend_Normal312_g56178;
				
				half Main_Metallic237_g56178 = ( tex2DNode35_g56178.r * _MainMetallicValue );
				half Second_Metallic226_g56178 = ( tex2DNode33_g56178.r * _SecondMetallicValue );
				float lerpResult278_g56178 = lerp( Main_Metallic237_g56178 , Second_Metallic226_g56178 , Mask_Detail147_g56178);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4064_g56178 = Main_Metallic237_g56178;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4064_g56178 = lerpResult278_g56178;
				#else
				float staticSwitch4064_g56178 = Main_Metallic237_g56178;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch299_g56178 = Main_Metallic237_g56178;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch299_g56178 = staticSwitch4064_g56178;
				#else
				float staticSwitch299_g56178 = Main_Metallic237_g56178;
				#endif
				half Blend_Metallic306_g56178 = staticSwitch299_g56178;
				float lerpResult342_g56178 = lerp( Blend_Metallic306_g56178 , 0.0 , Overlay_Mask269_g56178);
				half Final_Metallic367_g56178 = lerpResult342_g56178;
				
				float3 hdEmission4189_g56178 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g56467 = packedInput.ase_texcoord8.xy;
				half2 Emissive_UVs2468_g56178 = vertexToFrag11_g56467;
				half Global_Extras_Emissive4203_g56178 = break89_g56460.r;
				float lerpResult4206_g56178 = lerp( 1.0 , Global_Extras_Emissive4203_g56178 , _GlobalEmissive);
				half3 Final_Emissive2476_g56178 = ( (( hdEmission4189_g56178 * tex2D( _EmissiveTex, Emissive_UVs2468_g56178 ) )).rgb * lerpResult4206_g56178 );
				
				half Main_Smoothness227_g56178 = ( tex2DNode35_g56178.a * _MainSmoothnessValue );
				half Second_Smoothness236_g56178 = ( tex2DNode33_g56178.a * _SecondSmoothnessValue );
				float lerpResult266_g56178 = lerp( Main_Smoothness227_g56178 , Second_Smoothness236_g56178 , Mask_Detail147_g56178);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4065_g56178 = Main_Smoothness227_g56178;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4065_g56178 = lerpResult266_g56178;
				#else
				float staticSwitch4065_g56178 = Main_Smoothness227_g56178;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch297_g56178 = Main_Smoothness227_g56178;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch297_g56178 = staticSwitch4065_g56178;
				#else
				float staticSwitch297_g56178 = Main_Smoothness227_g56178;
				#endif
				half Blend_Smoothness314_g56178 = staticSwitch297_g56178;
				half Global_OverlaySmoothness311_g56178 = TVE_OverlaySmoothness;
				float lerpResult343_g56178 = lerp( Blend_Smoothness314_g56178 , Global_OverlaySmoothness311_g56178 , Overlay_Mask269_g56178);
				half Final_Smoothness371_g56178 = lerpResult343_g56178;
				half Global_Extras_Wetness305_g56178 = break89_g56460.g;
				float lerpResult3673_g56178 = lerp( 0.0 , Global_Extras_Wetness305_g56178 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g56178 = saturate( ( Final_Smoothness371_g56178 + lerpResult3673_g56178 ) );
				
				float lerpResult240_g56178 = lerp( 1.0 , tex2DNode35_g56178.g , _MainOcclusionValue);
				half Main_Occlusion247_g56178 = lerpResult240_g56178;
				float lerpResult239_g56178 = lerp( 1.0 , tex2DNode33_g56178.g , _SecondOcclusionValue);
				half Second_Occlusion251_g56178 = lerpResult239_g56178;
				float lerpResult294_g56178 = lerp( Main_Occlusion247_g56178 , Second_Occlusion251_g56178 , Mask_Detail147_g56178);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4066_g56178 = Main_Occlusion247_g56178;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4066_g56178 = lerpResult294_g56178;
				#else
				float staticSwitch4066_g56178 = Main_Occlusion247_g56178;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch310_g56178 = Main_Occlusion247_g56178;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch310_g56178 = staticSwitch4066_g56178;
				#else
				float staticSwitch310_g56178 = Main_Occlusion247_g56178;
				#endif
				half Blend_Occlusion323_g56178 = staticSwitch310_g56178;
				
				float localCustomAlphaClip3735_g56178 = ( 0.0 );
				half Final_AlphaFade3727_g56178 = 1.0;
				float Main_Alpha316_g56178 = ( _MainColor.a * tex2DNode29_g56178.a );
				half AlphaTreshold2132_g56178 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g56178 = ( Main_Alpha316_g56178 - ( AlphaTreshold2132_g56178 - 0.5 ) );
				#else
				float staticSwitch3792_g56178 = Main_Alpha316_g56178;
				#endif
				half Final_Alpha3754_g56178 = staticSwitch3792_g56178;
				float temp_output_661_0_g56178 = ( Final_AlphaFade3727_g56178 * Final_Alpha3754_g56178 );
				float Alpha3735_g56178 = temp_output_661_0_g56178;
				float Treshold3735_g56178 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g56178 - Treshold3735_g56178);
				#endif
				}
				half Final_Clip914_g56178 = saturate( Alpha3735_g56178 );
				
				surfaceDescription.Albedo = Final_Albedo359_g56178;
				surfaceDescription.Normal = Final_Normal366_g56178;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Final_Metallic367_g56178;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = Final_Emissive2476_g56178;
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g56178;
				surfaceDescription.Occlusion = Blend_Occlusion323_g56178;
				surfaceDescription.Alpha = Final_Clip914_g56178;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 lerpResult1545_g56178 = lerp( inputMesh.uv0.xy , inputMesh.uv1.xy , _DetailCoordMode);
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g56178 = lerpResult1545_g56178;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				...
				float3 vertexToFrag3890_g56178 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g56178;
				
				float2 vertexToFrag11_g56467 = ( ( inputMesh.uv0.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord5.xy = vertexToFrag11_g56467;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float staticSwitch3574_g56178 = Main_AlbedoTex_G3526_g56178;
				#endif
				float3 vertexToFrag3890_g56178 = packedInput.ase_texcoord4.xyz;
				float3 WorldPosition3905_g56178 = vertexToFrag3890_g56178;
				float3 Position82_g56460 = WorldPosition3905_g56178;
				float temp_output_84_0_g56460 = _LayerExtrasValue;
				float4 lerpResult88_g56460 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g56460).xz ) ),temp_output_84_0_g56460 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g56460]);
				...
				float3 hdEmission4189_g56178 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g56467 = packedInput.ase_texcoord5.xy;
				half2 Emissive_UVs2468_g56178 = vertexToFrag11_g56467;
				half Global_Extras_Emissive4203_g56178 = break89_g56460.r;
				float lerpResult4206_g56178 = lerp( 1.0 , Global_Extras_Emissive4203_g56178 , _GlobalEmissive);
				half3 Final_Emissive2476_g56178 = ( (( hdEmission4189_g56178 * tex2D( _EmissiveTex, Emissive_UVs2468_g56178 ) )).rgb * lerpResult4206_g56178 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 lerpResult1545_g56178 = lerp( inputMesh.ase_texcoord.xy , inputMesh.ase_texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g56178 = lerpResult1545_g56178;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				...
				float3 vertexToFrag3890_g56178 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag3890_g56178;
					...
					)
			{
				...
				float staticSwitch3574_g56178 = Main_AlbedoTex_G3526_g56178;
				#endif
				float3 vertexToFrag3890_g56178 = packedInput.ase_texcoord5.xyz;
				float3 WorldPosition3905_g56178 = vertexToFrag3890_g56178;
				float3 Position82_g56460 = WorldPosition3905_g56178;
				float temp_output_84_0_g56460 = _LayerExtrasValue;
				float4 lerpResult88_g56460 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g56460).xz ) ),temp_output_84_0_g56460 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g56460]);
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 vertexToFrag3890_g56178 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag3890_g56178;
				
				float2 vertexToFrag11_g56467 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord10.xy = vertexToFrag11_g56467;
						...
						)
			{
				...
				float staticSwitch3574_g56178 = Main_AlbedoTex_G3526_g56178;
				#endif
				float3 vertexToFrag3890_g56178 = packedInput.ase_texcoord9.xyz;
				float3 WorldPosition3905_g56178 = vertexToFrag3890_g56178;
				float3 Position82_g56460 = WorldPosition3905_g56178;
				float temp_output_84_0_g56460 = _LayerExtrasValue;
				float4 lerpResult88_g56460 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g56460).xz ) ),temp_output_84_0_g56460 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g56460]);
				...
				float3 hdEmission4189_g56178 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g56467 = packedInput.ase_texcoord10.xy;
				half2 Emissive_UVs2468_g56178 = vertexToFrag11_g56467;
				half Global_Extras_Emissive4203_g56178 = break89_g56460.r;
				float lerpResult4206_g56178 = lerp( 1.0 , Global_Extras_Emissive4203_g56178 , _GlobalEmissive);
				half3 Final_Emissive2476_g56178 = ( (( hdEmission4189_g56178 * tex2D( _EmissiveTex, Emissive_UVs2468_g56178 ) )).rgb * lerpResult4206_g56178 );
...
/*ASEBEGIN
Version=18912
1920;0;1920;1029;2720.445;415.538;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;406;-1344,-896;Inherit;False;Compile All Shaders;-1;;56177;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;407;-1536,-896;Inherit;False;Compile Core;-1;;56521;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;343;-2176,384;Inherit;False;Define Shader Object;-1;;56522;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=1AC7397BB7696F8A4028B0135BC356DFE10D3A7C
